...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.15.0-alpha.1583616621+g726e3cdd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.15.0-alpha.1583616621+g726e3cdd`
                """)
            else:
                raise
