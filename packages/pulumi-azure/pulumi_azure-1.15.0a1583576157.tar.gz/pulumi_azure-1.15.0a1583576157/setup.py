...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.15.0-alpha.1583576157+gcde097ed'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.15.0-alpha.1583576157+gcde097ed`
                """)
            else:
                raise
