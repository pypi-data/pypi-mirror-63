...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.1.0-alpha.1584112611+ge68aac14'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.1.0-alpha.1584112611+ge68aac14`
                """)
            else:
                raise
