...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.15.0-alpha.1583789556+g07f9515e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.15.0-alpha.1583789556+g07f9515e`
                """)
            else:
                raise
