...
def printlist(title, listdata=None):
    ...
    while k != "\n":
        ...
        print("\033[" + str(terminal_size[1] + 1) + ";0H"+str(select+1)+"/"+str(len(listdata))+" "+str(int((select+1)/len(listdata)*10000)/100)+"%", end="")
            ...
            if i -page+ 3 > 2 and i-page+1 < terminal_size[1]-2:
                if select == i:
                    ...
                    if subp.width_kana(listdata[i]) < terminal_size[0]:
                        print("\033[" + str(i -page+ 3) + ";0H\033[7m" + subp.center_kana(listdata[i], terminal_size[0],
                                                                                     " ") + "\033[0m")
                    else:
