...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.5.0-alpha.1584364445+gb1b5885'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.5.0-alpha.1584364445+gb1b5885`
                """)
            else:
                raise
