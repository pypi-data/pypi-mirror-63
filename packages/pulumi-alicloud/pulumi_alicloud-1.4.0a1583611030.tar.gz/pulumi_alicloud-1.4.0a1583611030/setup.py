...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.4.0-alpha.1583611030+g3a2bcba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.4.0-alpha.1583611030+g3a2bcba`
                """)
            else:
                raise
