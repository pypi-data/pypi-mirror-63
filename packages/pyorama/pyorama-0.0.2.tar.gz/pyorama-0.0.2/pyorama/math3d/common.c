...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pyorama.math3d.common",
        "sources": [
            "./pyorama/math3d/common.pyx"
        ]
    },
    "module_name": "pyorama.math3d.common"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyorama__math3d__common
#define __PYX_HAVE_API__pyorama__math3d__common
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <math.h>
...
static float __pyx_v_7pyorama_6math3d_6common_epsilon;
#define __Pyx_MODULE_NAME "pyorama.math3d.common"
extern int __pyx_module_is_main_pyorama__math3d__common;
int __pyx_module_is_main_pyorama__math3d__common = 0;

/* Implementation of 'pyorama.math3d.common' */
...
static int __Pyx_modinit_variable_export_code(void) {
  ...
  if (__Pyx_ExportVoidPtr(__pyx_n_s_epsilon, (void *)&__pyx_v_7pyorama_6math3d_6common_epsilon, "float") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pyorama__math3d__common) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyorama.math3d.common")) {
      if (unlikely(PyDict_SetItemString(modules, "pyorama.math3d.common", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyorama.math3d.common", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyorama.math3d.common");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
