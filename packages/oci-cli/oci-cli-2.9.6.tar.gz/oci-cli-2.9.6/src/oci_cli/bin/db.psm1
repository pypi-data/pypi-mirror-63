...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db system update' = 'backup-network-nsg-ids cpu-core-count data-storage-size-in-gbs db-system-id defined-tags force freeform-tags from-json help if-match max-wait-seconds nsg-ids patch-action patch-id shape ssh-authorized-keys-file wait-for-state wait-interval-seconds'
