...
[boto3.ApiGatewayManagementApi 1.12.20](https://boto3.amazonaws.com/v1/documentation/api/1.12.20/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service
