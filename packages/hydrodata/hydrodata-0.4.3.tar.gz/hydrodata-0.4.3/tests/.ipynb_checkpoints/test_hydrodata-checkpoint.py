...
def get_data():
    ...
    eta_grd = hds.ssebopeta_bygeom(wshed.geometry, start="2005-01-01", end="2005-01-5", resolution=60.0/3600.0)
    ...
    Q_daily = {'Piscataquis': (clm_loc['Q (cms)'], wshed.drainage_area),
