...
class VerificationContract(Model):
    ...
    def __init__(self, *, connection_id: str=None, verification_id: str=None, state=None, created_at_utc=None, updated_at_utc=None, is_valid: bool=None, verified_at_utc=None, **kwargs) -> None:
