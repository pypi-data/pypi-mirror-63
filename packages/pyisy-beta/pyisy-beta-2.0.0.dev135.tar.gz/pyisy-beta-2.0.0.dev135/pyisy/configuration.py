...
class Configuration(dict):
    ...
    def parse(self, xml):
        ...
        self["uuid"] = value_from_nested_xml(xmldoc, ["root", ATTR_ID])
        self["model"] = value_from_nested_xml(xmldoc, ["product", "desc"], "ISY")
        self["variables"] = bool(value_from_xml(xmldoc, "variables") == XML_TRUE)
        self["nodedefs"] = bool(value_from_xml(xmldoc, "nodedefs") == XML_TRUE)
