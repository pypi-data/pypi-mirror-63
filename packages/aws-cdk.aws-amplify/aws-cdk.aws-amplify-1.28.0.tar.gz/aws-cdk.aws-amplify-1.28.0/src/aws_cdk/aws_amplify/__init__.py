...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-amplify", "1.28.0", __name__, "aws-amplify@1.28.0.jsii.tgz")


@jsii.data_type(jsii_type="@aws-cdk/aws-amplify.AppProps", jsii_struct_bases=[], name_mapping={'access_token': 'accessToken', 'app_name': 'appName', 'auto_branch_creation': 'autoBranchCreation', 'basic_auth': 'basicAuth', 'build_spec': 'buildSpec', 'custom_rules': 'customRules', 'description': 'description', 'environment_variables': 'environmentVariables', 'oauth_token': 'oauthToken', 'repository': 'repository', 'role': 'role'})
class AppProps():
    def __init__(self, *, access_token: typing.Optional[aws_cdk.core.SecretValue]=None, app_name: typing.Optional[str]=None, auto_branch_creation: typing.Optional["AutoBranchCreation"]=None, basic_auth: typing.Optional["BasicAuth"]=None, build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec]=None, custom_rules: typing.Optional[typing.List["CustomRule"]]=None, description: typing.Optional[str]=None, environment_variables: typing.Optional[typing.Mapping[str,str]]=None, oauth_token: typing.Optional[aws_cdk.core.SecretValue]=None, repository: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None):
        """Properties for an App.

        :param access_token: Personal Access token for 3rd party source control system for an Amplify App, used to create webhook and read-only deploy key. Token is not stored. Either ``accessToken`` or ``oauthToken`` must be specified if ``repository`` is sepcified. Default: - use OAuth token
        ...
        :param oauth_token: OAuth token for 3rd party source control system for an Amplify App, used to create webhook and read-only deploy key. OAuth token is not stored. Either ``accessToken`` or ``oauthToken`` must be specified if ``repository`` is sepcified. Default: - use access token
        :param repository: The repository for the application. Must use the ``HTTPS`` protocol. Default: - not connected to a repository
        :param role: The IAM service role to associate with the application. Default: - a new role is created
...
class App(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-amplify.App"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, access_token: typing.Optional[aws_cdk.core.SecretValue]=None, app_name: typing.Optional[str]=None, auto_branch_creation: typing.Optional["AutoBranchCreation"]=None, basic_auth: typing.Optional["BasicAuth"]=None, build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec]=None, custom_rules: typing.Optional[typing.List["CustomRule"]]=None, description: typing.Optional[str]=None, environment_variables: typing.Optional[typing.Mapping[str,str]]=None, oauth_token: typing.Optional[aws_cdk.core.SecretValue]=None, repository: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param access_token: Personal Access token for 3rd party source control system for an Amplify App, used to create webhook and read-only deploy key. Token is not stored. Either ``accessToken`` or ``oauthToken`` must be specified if ``repository`` is sepcified. Default: - use OAuth token
        ...
        :stability: experimental
        """
        props = AppProps(access_token=access_token, app_name=app_name, auto_branch_creation=auto_branch_creation, basic_auth=basic_auth, build_spec=build_spec, custom_rules=custom_rules, description=description, environment_variables=environment_variables, oauth_token=oauth_token, repository=repository, role=role)
...
__all__ = ["App", "AppProps", "AutoBranchCreation", "BasicAuth", "BasicAuthConfig", "BasicAuthProps", "Branch", "BranchOptions", "BranchProps", "CfnApp", "CfnAppProps", "CfnBranch", "CfnBranchProps", "CfnDomain", "CfnDomainProps", "CustomRule", "Domain", "DomainOptions", "DomainProps", "IApp", "IBranch", "RedirectStatus", "SubDomain", "__jsii_assembly__"]
