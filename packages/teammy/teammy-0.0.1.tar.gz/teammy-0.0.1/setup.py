...
setup(
  ...
  description = 'Test show my first Library :)',   # Give a short description about your library
  ...
  url = 'https://fb.teammy.com/',   # Provide either the link to your github or to your website
