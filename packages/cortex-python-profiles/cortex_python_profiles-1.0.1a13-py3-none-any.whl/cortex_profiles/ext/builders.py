...
class BulkProfilesBuilder(AbstractProfilesBuilder):
    ...
    def build(self, verbose=False, chunk_size=10_000) -> Tuple[List,List]:
        ...
        * This method logs progress as chunks are incrementally saved ...
        ...
        log.debug('Consumed Invalid Event Chunk')
        ...
        while (next_attr_chunk is not None) or (next_event_chunk is not None) or (next_invalid_event_chunk is not None):
            ...
            if next_event_chunk is not None:
                ...
                log.debug('Handling Chunk of Events')
                (
                    new_profile_ids,
                    new_insert_records,
                    ...
                    chunk_index=next_event_chunk[0], document_chunk=events_in_chunk,
            ...
            if events_in_chunk:
                ...
                (
                    ...
                    chunk_index=next_event_chunk[0], document_chunk=attributes_in_events,
            ...
            if next_invalid_event_chunk is not None:
                log.debug('Handling Chunk of Invalid Events')
