...
class RestServerConnection(object):
    ...
    def __init__(
        ...
        self._low_level_http_client = LowLevelHTTPClient(
            server_address, default_retry=False, default_timeout=default_timeout
        )
    ...
    def send_notification(
        ...
        try:
            r = self._low_level_http_client.post(
                endpoint_url, payload=payload, check_status_code=True
            )
...
def get_rest_api_client(
    ...
    # type: (str, Optional[Dict[str, Any]], Optional[Dict[str, Any]], Optional[str], bool) -> RestApiClient
    if api_key is None:
