...
#
# Generated Sun Mar  8 17:20:49 2020 by generateDS.py version 2.35.15.
...
#
# Command line:
#   /root/init-build-jenkins.GZ8lfq/opennebula-5.10.3/src/oca/python/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class SNAPSHOTSType86Sub(TemplatedType, supermod.SNAPSHOTSType86):
    def __init__(self, ALLOW_ORPHANS=None, CURRENT_BASE=None, DISK_ID=None, NEXT_SNAPSHOT=None, SNAPSHOT=None, **kwargs_):
        super(SNAPSHOTSType86Sub, self).__init__(ALLOW_ORPHANS, CURRENT_BASE, DISK_ID, NEXT_SNAPSHOT, SNAPSHOT,  **kwargs_)
supermod.SNAPSHOTSType86.subclass = SNAPSHOTSType86Sub
# end class SNAPSHOTSType86Sub


class SNAPSHOTType87Sub(TemplatedType, supermod.SNAPSHOTType87):
    def __init__(self, ACTIVE=None, CHILDREN=None, DATE=None, ID=None, NAME=None, PARENT=None, SIZE=None, **kwargs_):
        super(SNAPSHOTType87Sub, self).__init__(ACTIVE, CHILDREN, DATE, ID, NAME, PARENT, SIZE,  **kwargs_)
supermod.SNAPSHOTType87.subclass = SNAPSHOTType87Sub
# end class SNAPSHOTType87Sub
...
class TEMPLATEType90Sub(TemplatedType, supermod.TEMPLATEType90):
    def __init__(self, VCENTER_CCR_REF=None, VCENTER_INSTANCE_ID=None, VCENTER_TEMPLATE_REF=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATEType90Sub, self).__init__(VCENTER_CCR_REF, VCENTER_INSTANCE_ID, VCENTER_TEMPLATE_REF, anytypeobjs_,  **kwargs_)
...
class TEMPLATEType93Sub(TemplatedType, supermod.TEMPLATEType93):
    def __init__(self, DISK=None, anytypeobjs_=None, NIC=None, NIC_ALIAS=None, **kwargs_):
        super(TEMPLATEType93Sub, self).__init__(DISK, anytypeobjs_, NIC, anytypeobjs_, NIC_ALIAS, anytypeobjs_,  **kwargs_)
supermod.TEMPLATEType93.subclass = TEMPLATEType93Sub
# end class TEMPLATEType93Sub


class DISKType94Sub(TemplatedType, supermod.DISKType94):
    def __init__(self, VCENTER_DS_REF=None, VCENTER_INSTANCE_ID=None, anytypeobjs_=None, **kwargs_):
        super(DISKType94Sub, self).__init__(VCENTER_DS_REF, VCENTER_INSTANCE_ID, anytypeobjs_,  **kwargs_)
supermod.DISKType94.subclass = DISKType94Sub
# end class DISKType94Sub


class NICType95Sub(TemplatedType, supermod.NICType95):
    def __init__(self, BRIDGE_TYPE=None, anytypeobjs_=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None, **kwargs_):
        super(NICType95Sub, self).__init__(BRIDGE_TYPE, anytypeobjs_, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE,  **kwargs_)
supermod.NICType95.subclass = NICType95Sub
# end class NICType95Sub
...
class USER_TEMPLATEType96Sub(TemplatedType, supermod.USER_TEMPLATEType96):
    def __init__(self, VCENTER_CCR_REF=None, VCENTER_DS_REF=None, VCENTER_INSTANCE_ID=None, anytypeobjs_=None, **kwargs_):
        super(USER_TEMPLATEType96Sub, self).__init__(VCENTER_CCR_REF, VCENTER_DS_REF, VCENTER_INSTANCE_ID, anytypeobjs_,  **kwargs_)
supermod.USER_TEMPLATEType96.subclass = USER_TEMPLATEType96Sub
# end class USER_TEMPLATEType96Sub


class HISTORY_RECORDSType97Sub(TemplatedType, supermod.HISTORY_RECORDSType97):
    def __init__(self, HISTORY=None, **kwargs_):
        super(HISTORY_RECORDSType97Sub, self).__init__(HISTORY,  **kwargs_)
supermod.HISTORY_RECORDSType97.subclass = HISTORY_RECORDSType97Sub
# end class HISTORY_RECORDSType97Sub


class HISTORYType98Sub(TemplatedType, supermod.HISTORYType98):
    def __init__(self, OID=None, SEQ=None, HOSTNAME=None, HID=None, CID=None, STIME=None, ETIME=None, VM_MAD=None, TM_MAD=None, DS_ID=None, PSTIME=None, PETIME=None, RSTIME=None, RETIME=None, ESTIME=None, EETIME=None, ACTION=None, UID=None, GID=None, REQUEST_ID=None, **kwargs_):
        super(HISTORYType98Sub, self).__init__(OID, SEQ, HOSTNAME, HID, CID, STIME, ETIME, VM_MAD, TM_MAD, DS_ID, PSTIME, PETIME, RSTIME, RETIME, ESTIME, EETIME, ACTION, UID, GID, REQUEST_ID,  **kwargs_)
supermod.HISTORYType98.subclass = HISTORYType98Sub
# end class HISTORYType98Sub


class SNAPSHOTSType99Sub(TemplatedType, supermod.SNAPSHOTSType99):
    def __init__(self, ALLOW_ORPHANS=None, CURRENT_BASE=None, DISK_ID=None, NEXT_SNAPSHOT=None, SNAPSHOT=None, **kwargs_):
        super(SNAPSHOTSType99Sub, self).__init__(ALLOW_ORPHANS, CURRENT_BASE, DISK_ID, NEXT_SNAPSHOT, SNAPSHOT,  **kwargs_)
supermod.SNAPSHOTSType99.subclass = SNAPSHOTSType99Sub
# end class SNAPSHOTSType99Sub


class SNAPSHOTType100Sub(TemplatedType, supermod.SNAPSHOTType100):
    def __init__(self, ACTIVE=None, CHILDREN=None, DATE=None, ID=None, NAME=None, PARENT=None, SIZE=None, **kwargs_):
        super(SNAPSHOTType100Sub, self).__init__(ACTIVE, CHILDREN, DATE, ID, NAME, PARENT, SIZE,  **kwargs_)
supermod.SNAPSHOTType100.subclass = SNAPSHOTType100Sub
# end class SNAPSHOTType100Sub


class VNETType101Sub(TemplatedType, supermod.VNETType101):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, PERMISSIONS=None, CLUSTERS=None, BRIDGE=None, BRIDGE_TYPE=None, PARENT_NETWORK_ID=None, VN_MAD=None, PHYDEV=None, VLAN_ID=None, OUTER_VLAN_ID=None, VLAN_ID_AUTOMATIC=None, OUTER_VLAN_ID_AUTOMATIC=None, USED_LEASES=None, VROUTERS=None, TEMPLATE=None, AR_POOL=None, **kwargs_):
        super(VNETType101Sub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, PERMISSIONS, CLUSTERS, BRIDGE, BRIDGE_TYPE, PARENT_NETWORK_ID, VN_MAD, PHYDEV, VLAN_ID, OUTER_VLAN_ID, VLAN_ID_AUTOMATIC, OUTER_VLAN_ID_AUTOMATIC, USED_LEASES, VROUTERS, TEMPLATE, AR_POOL,  **kwargs_)
supermod.VNETType101.subclass = VNETType101Sub
# end class VNETType101Sub


class PERMISSIONSType102Sub(TemplatedType, supermod.PERMISSIONSType102):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None, **kwargs_):
        super(PERMISSIONSType102Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A,  **kwargs_)
supermod.PERMISSIONSType102.subclass = PERMISSIONSType102Sub
# end class PERMISSIONSType102Sub


class CLUSTERSType103Sub(TemplatedType, supermod.CLUSTERSType103):
    def __init__(self, ID=None, **kwargs_):
        super(CLUSTERSType103Sub, self).__init__(ID,  **kwargs_)
supermod.CLUSTERSType103.subclass = CLUSTERSType103Sub
# end class CLUSTERSType103Sub
...
class LOCKType104Sub(TemplatedType, supermod.LOCKType104):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None, **kwargs_):
        super(LOCKType104Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID,  **kwargs_)
supermod.LOCKType104.subclass = LOCKType104Sub
# end class LOCKType104Sub


class PERMISSIONSType105Sub(TemplatedType, supermod.PERMISSIONSType105):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None, **kwargs_):
        super(PERMISSIONSType105Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A,  **kwargs_)
supermod.PERMISSIONSType105.subclass = PERMISSIONSType105Sub
# end class PERMISSIONSType105Sub


class CLUSTERSType106Sub(TemplatedType, supermod.CLUSTERSType106):
    def __init__(self, ID=None, **kwargs_):
        super(CLUSTERSType106Sub, self).__init__(ID,  **kwargs_)
supermod.CLUSTERSType106.subclass = CLUSTERSType106Sub
# end class CLUSTERSType106Sub


class VROUTERSType107Sub(TemplatedType, supermod.VROUTERSType107):
    def __init__(self, ID=None, **kwargs_):
        super(VROUTERSType107Sub, self).__init__(ID,  **kwargs_)
supermod.VROUTERSType107.subclass = VROUTERSType107Sub
# end class VROUTERSType107Sub


class TEMPLATEType108Sub(TemplatedType, supermod.TEMPLATEType108):
    def __init__(self, CONTEXT_FORCE_IPV4=None, DNS=None, GATEWAY=None, GATEWAY6=None, GUEST_MTU=None, NETWORK_ADDRESS=None, NETWORK_MASK=None, SEARCH_DOMAIN=None, VCENTER_FROM_WILD=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None, VCENTER_TEMPLATE_REF=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATEType108Sub, self).__init__(CONTEXT_FORCE_IPV4, DNS, GATEWAY, GATEWAY6, GUEST_MTU, NETWORK_ADDRESS, NETWORK_MASK, SEARCH_DOMAIN, VCENTER_FROM_WILD, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, VCENTER_TEMPLATE_REF, anytypeobjs_,  **kwargs_)
supermod.TEMPLATEType108.subclass = TEMPLATEType108Sub
# end class TEMPLATEType108Sub


class AR_POOLType109Sub(TemplatedType, supermod.AR_POOLType109):
    def __init__(self, AR=None, **kwargs_):
        super(AR_POOLType109Sub, self).__init__(AR,  **kwargs_)
supermod.AR_POOLType109.subclass = AR_POOLType109Sub
# end class AR_POOLType109Sub


class ARType110Sub(TemplatedType, supermod.ARType110):
    def __init__(self, AR_ID=None, GLOBAL_PREFIX=None, IP=None, MAC=None, PARENT_NETWORK_AR_ID=None, SIZE=None, TYPE=None, ULA_PREFIX=None, VN_MAD=None, MAC_END=None, IP_END=None, IP6_ULA=None, IP6_ULA_END=None, IP6_GLOBAL=None, IP6_GLOBAL_END=None, IP6=None, IP6_END=None, USED_LEASES=None, LEASES=None, **kwargs_):
        super(ARType110Sub, self).__init__(AR_ID, GLOBAL_PREFIX, IP, MAC, PARENT_NETWORK_AR_ID, SIZE, TYPE, ULA_PREFIX, VN_MAD, MAC_END, IP_END, IP6_ULA, IP6_ULA_END, IP6_GLOBAL, IP6_GLOBAL_END, IP6, IP6_END, USED_LEASES, LEASES,  **kwargs_)
supermod.ARType110.subclass = ARType110Sub
# end class ARType110Sub
...
class TEMPLATEType113Sub(TemplatedType, supermod.TEMPLATEType113):
    def __init__(self, VN_MAD=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATEType113Sub, self).__init__(VN_MAD, anytypeobjs_,  **kwargs_)
supermod.TEMPLATEType113.subclass = TEMPLATEType113Sub
# end class TEMPLATEType113Sub
...
class LOCKType115Sub(TemplatedType, supermod.LOCKType115):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None, **kwargs_):
        super(LOCKType115Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID,  **kwargs_)
supermod.LOCKType115.subclass = LOCKType115Sub
# end class LOCKType115Sub


class VMSType116Sub(TemplatedType, supermod.VMSType116):
    def __init__(self, ID=None, **kwargs_):
        super(VMSType116Sub, self).__init__(ID,  **kwargs_)
supermod.VMSType116.subclass = VMSType116Sub
# end class VMSType116Sub
...
class TEMPLATEType117Sub(TemplatedType, supermod.TEMPLATEType117):
    def __init__(self, ENDPOINT=None, **kwargs_):
        super(TEMPLATEType117Sub, self).__init__(ENDPOINT,  **kwargs_)
supermod.TEMPLATEType117.subclass = TEMPLATEType117Sub
# end class TEMPLATEType117Sub
...
class TEMPLATEType118Sub(TemplatedType, supermod.TEMPLATEType118):
    def __init__(self, ENDPOINT=None, **kwargs_):
        super(TEMPLATEType118Sub, self).__init__(ENDPOINT,  **kwargs_)
supermod.TEMPLATEType118.subclass = TEMPLATEType118Sub
# end class TEMPLATEType118Sub


class SERVER_POOLType119Sub(TemplatedType, supermod.SERVER_POOLType119):
    def __init__(self, SERVER=None, **kwargs_):
        super(SERVER_POOLType119Sub, self).__init__(SERVER,  **kwargs_)
supermod.SERVER_POOLType119.subclass = SERVER_POOLType119Sub
# end class SERVER_POOLType119Sub


class SERVERType120Sub(TemplatedType, supermod.SERVERType120):
    def __init__(self, ENDPOINT=None, ID=None, NAME=None, STATE=None, TERM=None, VOTEDFOR=None, COMMIT=None, LOG_INDEX=None, FEDLOG_INDEX=None, **kwargs_):
        super(SERVERType120Sub, self).__init__(ENDPOINT, ID, NAME, STATE, TERM, VOTEDFOR, COMMIT, LOG_INDEX, FEDLOG_INDEX,  **kwargs_)
supermod.SERVERType120.subclass = SERVERType120Sub
# end class SERVERType120Sub
