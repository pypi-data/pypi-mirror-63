...
class ServoWidget(widgets.NQWidget):
    ...
    def setCallbacks(self):
        ...
        widgets.servo_section.RampWidget(self._servoNumber).setCallbacks()
        ...
        return html.Details(
            children=[
                html.Summary(
                    children=[
                        html.Span(
                            [controller.getServoName(self._servoNumber)],
                            ...
                            children=[
                                ...
                                html.Div(
                                    children=[
                                        ...
                                        html.Div(
                                            [
                                                widgets.servo_section.RampWidget(
                                                    self._servoNumber
                                                ).layout
                                            ],
    ...
    def _servoNameCallback(self, submit, name):
        return controller.callServoName(self._servoNumber, submit, name)
