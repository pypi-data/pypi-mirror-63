...
#                                     + str(refset ^ funcset) + errdict)
    ...
    def __getstate__(self):
        ...
        print('dropping fn-coefficients to allow pickling...')
        ...
        if self.lambda_backend == 'symengine':
            import warnings
            warnings.warn('the resulting dump of the _fnevals functions ' +
...
#                )
    ...
    def _calc_Fint_1(self):
        ...
        multip = self._mu_0_x * self.S2_mu(mu1, self.V.tau)
    ...
    def _calc_Fint_2(self):
        ...
        multip = self._mu_ex_x * self.S2_mu(mu1, self.V.tau)
        S = np.sum(fn * multip, axis=0)
        return S
