...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of vrt_lss_merchandiser.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = vrt_lss_merchandiser.Configuration(
    ...
    Note you can use the constants defined in the vrt_lss_merchandiser.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = vrt_lss_merchandiser.Configuration(
        signing_info = vrt_lss_merchandiser.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 2.3.155767\n"\
               "SDK Package Version: 2.3.155767".\
