...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, pulp_href=None, pulp_created=None, base_path=None, name=None, content_guard=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
