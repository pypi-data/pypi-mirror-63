...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, content_guard=None, base_path=None, repository=None, name=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
