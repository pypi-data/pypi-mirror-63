...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, pulp_href=None, content_guard=None, base_path=None, repository=None, repository_version=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
