...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, pulp_href=None, content_guard=None, pulp_created=None, name=None, repository_version=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
