...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, name=None, repository=None, content_guard=None, pulp_href=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
