...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, repository_version=None, name=None, base_path=None, pulp_href=None, content_guard=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
