...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, pulp_href=None, repository_version=None, base_path=None, pulp_created=None, name=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
