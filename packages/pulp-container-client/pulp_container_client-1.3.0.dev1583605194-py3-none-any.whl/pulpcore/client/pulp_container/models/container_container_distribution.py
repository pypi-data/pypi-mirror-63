...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, pulp_href=None, content_guard=None, pulp_created=None, name=None, repository=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
