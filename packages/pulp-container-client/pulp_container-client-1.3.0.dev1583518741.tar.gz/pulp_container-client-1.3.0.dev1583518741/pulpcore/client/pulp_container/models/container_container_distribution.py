...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, repository_version=None, content_guard=None, repository=None, base_path=None, name=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
