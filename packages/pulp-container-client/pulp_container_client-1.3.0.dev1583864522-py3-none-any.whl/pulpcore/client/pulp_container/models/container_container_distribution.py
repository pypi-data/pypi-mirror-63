...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, base_path=None, repository_version=None, name=None, pulp_created=None, pulp_href=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
