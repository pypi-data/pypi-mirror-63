...
[boto3.MigrationHubConfig 1.12.16](https://boto3.amazonaws.com/v1/documentation/api/1.12.16/reference/services/migrationhub-config.html#MigrationHubConfig) service
