...
[boto3.ServerlessApplicationRepository 1.12.23](https://boto3.amazonaws.com/v1/documentation/api/1.12.23/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
