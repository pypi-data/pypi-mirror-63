...
class ListApplicationDependenciesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApplicationDependencies.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.16/reference/services/serverlessrepo.html#ServerlessApplicationRepository.Paginator.ListApplicationDependencies.paginate)
        """
...
class ListApplicationVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApplicationVersions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.16/reference/services/serverlessrepo.html#ServerlessApplicationRepository.Paginator.ListApplicationVersions.paginate)
        """
...
class ListApplicationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApplications.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.16/reference/services/serverlessrepo.html#ServerlessApplicationRepository.Paginator.ListApplications.paginate)
        """
