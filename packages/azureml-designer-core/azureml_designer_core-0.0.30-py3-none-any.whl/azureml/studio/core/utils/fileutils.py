...
def make_zipfile_exclude(zip_file_path, folder_to_zip, exclude_function=None):
    ...
    :param folder_to_zip: Directory that will be zipped.
    ...
    with zipfile.ZipFile(zip_file_path, "w") as zf:
        for dirpath, dirnames, filenames in os.walk(folder_to_zip):
            relative_dirpath = os.path.relpath(dirpath, folder_to_zip)
