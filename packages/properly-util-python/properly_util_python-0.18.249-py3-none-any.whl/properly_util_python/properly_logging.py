...
def _standardize_tags(tags: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    standardized_tags = {}
    if not tags:
        return standardized_tags

    for key, value in tags.items():
        if key in STANDARD_FORMAT_MAPPER:
            standardized_tags[STANDARD_FORMAT_MAPPER[key]] = value
        else:
            standardized_tags[key] = value
...
class ProperLogger:
    ...
    def __init__(self, log_location: str, common_tags: Dict[str, Any] = None, logger=None):
        """
        ...
        if logger:
            ...
            self.logger.level = os.environ.get('PROPERLY_LOG_LEVEL', logging.INFO)
    ...
    def add_common_tags(self, common_tags: Dict[str, Any]):
        """
    ...
    def debug(self, message: str, extra_tags: Dict[str, Any] = None):
        """
    ...
    def info(self, message: str, extra_tags: Dict[str, Any] = None):
        """
    ...
    def metric(self, name: str, value: Any, extra_tags: Dict[str, Any] = None):
        """
    ...
    def warning(self, name: str, message: str, extra_tags: Dict[str, Any] = None):
        """
    ...
    def error(self, name: str, message: str, extra_tags: Dict[str, Any] = None):
        """
    ...
    def exception(self, name: str, message: str, extra_tags: Dict[str, Any] = None):
        """
