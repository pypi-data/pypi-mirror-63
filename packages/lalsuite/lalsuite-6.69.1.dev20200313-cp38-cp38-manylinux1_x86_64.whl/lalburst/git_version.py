...
id = "bdacc6cbcd69a0f8b160ecc549e1bdd5c1f71a16"
date = "2020-03-12 13:12:37 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "bdacc6cbcd69a0f8b160ecc549e1bdd5c1f71a16":
        return
    msg = "Program id (bdacc6cbcd69a0f8b160ecc549e1bdd5c1f71a16) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
