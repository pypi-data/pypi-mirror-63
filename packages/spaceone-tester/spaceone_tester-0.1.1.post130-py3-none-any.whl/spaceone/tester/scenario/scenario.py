...
class Scenario(object):
    ...
    def run_scenario(self):
        ...
        if domain_scenario:
            ...
            credential_name2id = secret_runner.create_or_update_secrets(secrets, domain)
            ...
            secret_group_runner = SecretGroupRunner(
                self.clients,
                update_mode=self.is_update_mode,
                credential_name2id=credential_name2id
            )
            credential_group_name2id = secret_group_runner.create_or_update_secret_group(secret_group, domain)
            ...
            collector_runner = CollectorRunner(
                ...
                update_mode=self.is_update_mode,
                credential_name2id=credential_name2id,
                credential_group_name2id=credential_group_name2id
            )
