...
class SteamClient(CMClient, BuiltinBase):
    ...
    def login(self, username, password='', login_key=None, auth_code=None, two_factor_code=None, login_id=None):
        ...
        if login_id is None:
            message.body.deprecated_obfustucated_private_ip = ip_to_int(self.connection.local_address) ^ 0xF00DBAAD
        else:
            message.body.deprecated_obfustucated_private_ip = login_id
