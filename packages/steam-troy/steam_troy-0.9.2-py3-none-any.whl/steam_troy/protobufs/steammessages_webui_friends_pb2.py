...
_CCOMMUNITY_MARKPARTNEREVENTSFORUSER_REQUEST_PARTNEREVENTMARKING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\202\265\030\004enum', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
xCCommunity_ClanAnnouncementInfo = _reflection.GeneratedProtocolMessageType('xCCommunity_ClanAnnouncementInfo', (_message.Message,), {
...
xCMsgClientSecret = _reflection.GeneratedProtocolMessageType('xCMsgClientSecret', (_message.Message,), {
