...
class ModelMetadata(NamedTuple):
    ...
    @classmethod
    def from_json(cls, model_metadata: [str, Dict]) -> 'ModelMetadata':
        ...
        # Resolve classes
        classes_resolved = [SegmentationClass(seg_class, color) for seg_class, color in zip(spec["Classes"], color_gen)]
    ...
    def from_params(cls,
                    ...
                    border_size: int,
                    name: str = "DNN Model",
                    license_file: str = None) -> 'ModelMetadata':
...
class ModelSpec(NamedTuple):
    ...
    def from_json(cls, model_spec_path: str) -> 'ModelSpec':
        ...
        return ModelSpec(model=spec["ModelPath"], model_metadata=ModelMetadata.from_json(spec))
