...
`nurbspy` is also available on Linux via the [conda](https://pip.pypa.io/en/stable/). In order to install `nurbspy` via conda you need to add `roberagro` to your channels and when you use the install command
