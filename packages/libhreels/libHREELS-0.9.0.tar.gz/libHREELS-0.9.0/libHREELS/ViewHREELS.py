...
class HREELS_Window(QtWidgets.QMainWindow):
    ...
    def __init__(self,datapath= None, remoteDir=None, startWithFile=None):
        ...
        if remoteDir and os.path.exists(remoteDir):
            ...
            self.remoteDir = '\\\\141.48.167.189\\BackUp02\\0_experiments\\EELS-PC4\\HREELS\\gph_dat\\2019'
        self.wideScan = True
        self.marker = []
...
def runViewer(datapath= None, remoteDir=None, startWithFile=None):
    ...
    form = HREELS_Window(datapath= datapath, remoteDir=remoteDir, startWithFile=startWithFile)
    form.show()
    sys.exit(app.exec_())
