...
if __name__ == '__main__':
    ...
    '''
    ff = conn.bss.query_customer_period_resources_list(userDomainId, **data)
    print(ff)
    ...
    '''
    ff = conn.bss.renew_subscription_by_resourceId(userDomainId, **data)
    print(ff)
    ...
    This API can be invoked using the customer token only.    
    '''
    ff = conn.bss.unsubscribe_by_resourceId(userDomainId, **data)
    print(ff)
    ...
    This API can be invoked using the customer token only.    
    '''
    ff = conn.bss.enable_auto_renew(userDomainId, resource_id="3e88931a-ddfe-4364-8604-84cd0882ad47", action_id="autorenew")
    print(ff)
    ...
    This API can be invoked using the customer token only.    
    '''
    ff = conn.bss.disable_auto_renew(userDomainId, resource_id="3e88931a-ddfe-4364-8604-84cd0882ad47", action_id="autorenew")
    print(ff)
