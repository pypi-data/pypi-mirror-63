...
if __name__ == '__main__':
    ...
    '''
    ff = conn.bss.individual_realname_auth(userDomainId, **data)
    print(ff)
    ...
    This API can be invoked only by the partner account AK/SK or token.
    '''
    ff = conn.bss.enterprise_realname_auth(userDomainId, **data)
    print(ff)
    ...
    This API can be invoked only by the partner account AK/SK or token.
    '''
    ff = conn.bss.change_enterprise_realname_auth(userDomainId, **data)
    print(ff)
    ...
    This API can be invoked only by the partner account AK/SK or token.
    '''
    ff = conn.bss.query_realname_auth(userDomainId, **data)
    print(ff)
