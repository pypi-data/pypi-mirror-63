...
def unjsonize_mapping_dataframe(mapping_df):
    ...
    for col in mapping_df.columns :
        ...
        human_readable_dictionary[signal_name] = run_json_string
        ...
        if not jsonized_output :
            ...
            for col in results_df.columns:
                if col != 'Date':
                    ...
                    renaming_dictionary[col] = params['signal_type']+str(params['transaction_costs'])+str(params['normalization'])+salty
