...
class NaPoleonDropboxConnector(object):
    ...
    def local_features_npy_ovverwrite_and_load_array(self, starting_date = None, ending_date = None, feature_type=None,
                                           ...
                                           features_saving_suffix='', features_names_saving_suffix='',shortcut_features_saving_suffix = ''):
        ...
        shortcut_features = pd.read_pickle(shortcut_features_file_full_path)

        return features, features_names, shortcut_features
