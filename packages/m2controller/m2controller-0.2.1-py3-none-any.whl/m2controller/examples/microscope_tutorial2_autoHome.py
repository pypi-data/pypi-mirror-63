...
###########################
# improvement from tutorial1:
#	use feedback from x/y +/- limit buttons to auto home
###########################
...
controller = m2controller.BleCtrller(m2Const.etLocalNet,callbackfunc,usrCfg.BleMACinfoList,None,usrCfg.RaspberrPiName,0,usrCfg.IntranetHostIPaddr,None,None,None)
