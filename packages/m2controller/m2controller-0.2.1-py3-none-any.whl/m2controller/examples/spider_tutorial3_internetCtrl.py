...
controller = m2controller.BleCtrller(m2Const.etInternetController,None,None,None,0,usrCfg.InternetHostIPaddr,usrCfg.mqttPort,usrCfg.mqttusername,usrCfg.mqttpassword)
controller.connect()
