...
from tensorflow_data_validation.types_compat import Any, Dict, Hashable, Iterable, Optional, Text, Tuple, TypeVar
...
class ConstituentStatsGenerator(object):
  ...
  @abc.abstractmethod
  def extract_output(self, accumulator                     )       :  # pytype: disable=invalid-annotation
    """Returns result of converting accumulator into the output value.
