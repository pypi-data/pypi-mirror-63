...
def generate_report(opts):
    ...
    <div class="sidenav">
        <a> <img src="%s" style="height:20vh;max-width:100%%;"/> </a>
        <a class="tablink" href="#" id="defaultOpen" onclick="openPage('dashboard', this, ' #929596')"><i class="fa fa-dashboard"></i> Dashboard</a>
        <a class="tablink" href="#" onclick="openPage('suiteMetrics', this, ' #929596'); executeDataTable('#sm',5)"><i class="fa fa-th-large"></i> Suite Metrics</a>
        <a class="tablink" href="#" onclick="openPage('testMetrics', this, ' #929596'); executeDataTable('#tm',3)"><i class="fa fa-list-alt"></i> Test Metrics</a>
        <a class="tablink" href="#" onclick="openPage('keywordMetrics', this, ' #929596'); executeDataTable('#km',3)"><i class="fa fa-table"></i> Keyword Metrics</a>
        <a class="tablink" href="#" onclick="openPage('log', this, ' #929596');"><i class="fa fa-wpforms"></i> Logs</a>
        <a class="tablink" href="#" onclick="openPage('statistics', this, ' #929596');"><i class="fa fa-envelope-o"></i> Email</a>
    </div>
    """ % logo
    ...
    <div class="tabcontent" id="dashboard">
                    ...
                    <div class="col-md-12" style="height:25px;width:auto;">
                        <p class="text-muted" style="text-align:center;font-size:9px">
                            <a target="_blank" href="https://github.com"> Graph-Report </a>
                        </p>
                    </div>
                    </div>
