...
setuptools.setup(
    name="wenjuantest66",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.0.1",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    #author="kagome",                                       # 作者名字
    #author_email="wenjuan913@sina.com",                      # 作者邮箱
    maintainer='another',                                   #维护人姓名
    maintainer_email='fengshaomin@qq.com',                  #维护人邮箱
    description="美丽的星空",                            # 包的简介描述
