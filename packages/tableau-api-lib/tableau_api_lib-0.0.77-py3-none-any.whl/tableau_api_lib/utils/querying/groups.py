...
def get_group_users_dataframe(conn, group_id):
    ...
    all_group_users = group_users_df.merge(users_df, how='left', left_on='id', right_on='id', suffixes=('delete', None))
