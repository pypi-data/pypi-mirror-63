...
_RESOURCECONF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cube_config_file', full_name='baidu.paddle_serving.configure.ResourceConf.cube_config_file', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='general_model_path', full_name='baidu.paddle_serving.configure.ResourceConf.general_model_path', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='general_model_file', full_name='baidu.paddle_serving.configure.ResourceConf.general_model_file', index=4,
