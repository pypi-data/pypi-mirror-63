...
setuptools.setup(name='ephysiopy',
	  ...
	  scripts=["ephysiopy/scripts/RENAME_ME_oe2axona_debugging.py", "ephysiopy/scripts/RENAME_ME_oe2axona_multiplefiles.py",
	  			"ephysiopy/scripts/RENAME_ME_oe2numpy_script.py"],
