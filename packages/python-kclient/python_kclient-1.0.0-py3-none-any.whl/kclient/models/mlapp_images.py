...
class MlappImages(object):
    ...
    @property
    def cpu(self):
        """Gets the cpu of this MlappImages.  # noqa: E501


        :return: The cpu of this MlappImages.  # noqa: E501
        :rtype: str
        """
        return self._cpu
    ...
    @cpu.setter
    def cpu(self, cpu):
        """Sets the cpu of this MlappImages.


        :param cpu: The cpu of this MlappImages.  # noqa: E501
        :type: str
        """
        if cpu is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MlappImages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MlappImages):
            return False
