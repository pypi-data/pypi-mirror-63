...
class MlappPort(object):
    ...
    @property
    def name(self):
        """Gets the name of this MlappPort.  # noqa: E501


        :return: The name of this MlappPort.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MlappPort.


        :param name: The name of this MlappPort.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def port(self):
        """Gets the port of this MlappPort.  # noqa: E501


        :return: The port of this MlappPort.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this MlappPort.


        :param port: The port of this MlappPort.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MlappPort):
            return False
