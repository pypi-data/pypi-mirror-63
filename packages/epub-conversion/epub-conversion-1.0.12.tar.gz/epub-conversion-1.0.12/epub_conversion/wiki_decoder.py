...
def convert_wiki_to_lines_inner_generator(wiki, verbose, report_every, skip_cdata, encoding, inner_element, element,
...
def convert_wiki_to_lines(wiki,
    ...
    if parallel and isinstance(fin, io.BufferedReader):
        ...
        workers = [Process(target=convert_wiki_to_lines_inner_queue,
                           args=(result_queue, fname, False, report_every, skip_cdata, encoding, inner_element, element,
        ...
        # do sequential processing
        for article, title in convert_wiki_to_lines_inner_generator(wiki, True, report_every, skip_cdata, encoding, inner_element, element,
