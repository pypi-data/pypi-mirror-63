...
FACTORIES_VIEW = """{% for required_lib in app_config.factory_required_libs %}{{ required_lib }}
{% endfor %}
{% for required_module in app_config.factory_required_modules %}{{ required_module }}
{% endfor %}
