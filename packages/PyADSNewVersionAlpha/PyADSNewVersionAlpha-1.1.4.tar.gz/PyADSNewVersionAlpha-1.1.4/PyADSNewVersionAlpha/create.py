    ...
    try:
        with connection() as conn:
            ...
            if command_type == "regular":
                ...
                new_project = f"SELECT TOP (20) [connection_name],[server_name],[database_name],[provider],[custom_connect_string],[connection_expression] FROM [elt].[oledb_connection] order by [connection_name] desc"
