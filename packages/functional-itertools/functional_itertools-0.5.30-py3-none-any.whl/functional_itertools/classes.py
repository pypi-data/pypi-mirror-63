...
class CList(List[_T]):
    ...
    def range(
        ...
        return CIterable.range(start, stop=stop, step=step).list()
...
class CSet(Set[_T]):
    ...
    def range(
        ...
        return CIterable.range(start, stop=stop, step=step).set()
    ...
    def zip(
        self: "CSet[_T]", *iterables: Iterable[_U],
    ) -> "CSet[Tuple[Union[_T, _U]]]":
...
class CFrozenSet(FrozenSet[_T]):
    ...
    def range(
        ...
        return CIterable.range(start, stop=stop, step=step).frozenset()
    ...
    def sum(
        self: "CFrozenSet[_T]", start: Union[_T, int] = 0,
    ) -> Union[_T, int]:
        return self.iter().sum(start=start)
