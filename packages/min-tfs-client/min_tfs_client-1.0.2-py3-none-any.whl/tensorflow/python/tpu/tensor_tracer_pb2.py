...
TensorTracerReport = _reflection.GeneratedProtocolMessageType('TensorTracerReport', (_message.Message,), dict(

  TensordefEntry = _reflection.GeneratedProtocolMessageType('TensordefEntry', (_message.Message,), dict(
  ...
  TensorTracerConfig = _reflection.GeneratedProtocolMessageType('TensorTracerConfig', (_message.Message,), dict(
  ...
  TracedTensorDef = _reflection.GeneratedProtocolMessageType('TracedTensorDef', (_message.Message,), dict(
