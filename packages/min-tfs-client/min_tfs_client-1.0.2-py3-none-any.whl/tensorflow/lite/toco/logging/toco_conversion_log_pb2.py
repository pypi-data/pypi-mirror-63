...
TocoConversionLog = _reflection.GeneratedProtocolMessageType('TocoConversionLog', (_message.Message,), dict(

  BuiltInOpsEntry = _reflection.GeneratedProtocolMessageType('BuiltInOpsEntry', (_message.Message,), dict(
  ...
  CustomOpsEntry = _reflection.GeneratedProtocolMessageType('CustomOpsEntry', (_message.Message,), dict(
  ...
  SelectOpsEntry = _reflection.GeneratedProtocolMessageType('SelectOpsEntry', (_message.Message,), dict(
