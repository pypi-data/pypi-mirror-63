...
from tensorflow.lite.tools.evaluation.proto import evaluation_stages_pb2 as tensorflow_dot_lite_dot_tools_dot_evaluation_dot_proto_dot_evaluation__stages__pb2
...
EvaluationStageConfig = _reflection.GeneratedProtocolMessageType('EvaluationStageConfig', (_message.Message,), dict(
...
EvaluationStageMetrics = _reflection.GeneratedProtocolMessageType('EvaluationStageMetrics', (_message.Message,), dict(
