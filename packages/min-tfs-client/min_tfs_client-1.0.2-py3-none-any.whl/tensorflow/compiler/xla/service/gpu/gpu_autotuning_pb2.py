...
from tensorflow.core.protobuf import autotuning_pb2 as tensorflow_dot_core_dot_protobuf_dot_autotuning__pb2
...
ConvInstructionLog = _reflection.GeneratedProtocolMessageType('ConvInstructionLog', (_message.Message,), dict(
...
BlacklistedAlgorithm = _reflection.GeneratedProtocolMessageType('BlacklistedAlgorithm', (_message.Message,), dict(
...
AlgorithmBlacklistEntry = _reflection.GeneratedProtocolMessageType('AlgorithmBlacklistEntry', (_message.Message,), dict(
...
AlgorithmBlacklist = _reflection.GeneratedProtocolMessageType('AlgorithmBlacklist', (_message.Message,), dict(
