...
def get_app_status(exposed_fields=("name", "description", "version"), health_check=None):
    """
    Gets the Cloud Function Status from the package.json file and augments with Health information.

    By Default exposes the app name, description and version and sets the health status to OK
    ...
    with open("package.json", "r") as package:
        package_json = json.loads(package.read())
