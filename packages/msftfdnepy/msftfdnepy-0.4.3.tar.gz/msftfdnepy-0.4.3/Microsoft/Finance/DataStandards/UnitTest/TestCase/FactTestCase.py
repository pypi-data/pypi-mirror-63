...
class FactTestCase(unittest.TestCase):
    ...
    def test_aggregation_efficiency(self) -> None:
        ...
        if not self.__excludeFromAggregation:
            self.skipTest("the set of columns excluded from aggregation testing cannot be None or empty...")
    ...
    def test_column_categories(self) -> None:
        ...
        eventCode1 = "dimension-keys-col-categories"
