...
from raportylib.send_report import gen_report
...
def init_schedule(scheduler, cmd, http):            
    ...
    scheduler.add_task("daily(at='21:30', in_weekdays=range(0,5))", send_reports,  "5. Coddziennie w dni robocze")
    scheduler.add_task("monthly(day=1, at='21:35')", send_reports,  "6. Dwa razy w miesiÄ…cu")
    scheduler.add_task("monthly(day=15, at='21:35')", send_reports,  "6. Dwa razy w miesiÄ…cu")
    scheduler.add_task("monthly(day=7, at='21:40')", send_reports,  "7. Raz w miesiÄ…cu")
    scheduler.add_task("monthly(day=31, at='21:45', in_months=(3,6,9,12) )", send_reports,  "8. Raz w kwartale")
    scheduler.add_task("monthly(day=31, at='21:50', in_months=(6,12) )", send_reports,  "9. Raz na pÃ³Å‚ roku")
    scheduler.add_task("monthly(day=31, at='21:55', in_months=(12,) )", send_reports,  "10. Raz do roku")
    ...
    scheduler.add_task("daily(at='21:30')", send_reports,  "15. Codziennie - takÅ¼e w dni wolne") 
    scheduler.add_task("daily(at='22:00', in_weekdays=(6,))", send_reports,  "16. Raz w tygodniu")
    
    scheduler.add_task("daily(at='09:00', in_weekdays=range(0,5))", send_reports,  "17. Beggining of business day")
    scheduler.add_task("daily(at='12:00', in_weekdays=range(0,5))", send_reports,  "18. At noon  on a business day")
    scheduler.add_task("daily(at='17:00', in_weekdays=range(0,5))", send_reports,  "19. End of business day")    
    
    scheduler.add_task("daily(at='21:25', in_weekdays=(0,))", send_reports,  "20. W poniedziałki")
    scheduler.add_task("daily(at='21:25', in_weekdays=(1,))", send_reports,  "21. We wtorki")
    scheduler.add_task("daily(at='21:25', in_weekdays=(2,))", send_reports,  "22. W środy")
    scheduler.add_task("daily(at='21:25', in_weekdays=(3,))", send_reports,  "23. W czwartki")
    scheduler.add_task("daily(at='21:25', in_weekdays=(4,))", send_reports,  "24. W piątki")
