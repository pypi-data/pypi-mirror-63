...
Urls  = (
    ...
    ('table/ErpCustomer/-/form/list/?schtml=desktop',_('Klienci'),None,'png://apps/system-users.png'),
    ('table/RetPallets/-/form/list/?schtml=desktop',_('Zwroty palet'),None,'png://actions/edit-redo.png'),
)
