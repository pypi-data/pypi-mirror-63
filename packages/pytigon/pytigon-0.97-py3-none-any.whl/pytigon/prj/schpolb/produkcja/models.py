...
class Cuw( models.Model):
    
    class Meta:
        verbose_name = _("Cuw")
        verbose_name_plural = _("Cuw")
        default_permissions = ('add', 'change', 'delete', 'list')
        app_label = 'produkcja'
    ...
    year = models.IntegerField('Year', null=False, blank=False, editable=True, )
    month = models.IntegerField('Month', null=False, blank=False, editable=True, )
    mag = models.CharField('Magazyn', null=False, blank=False, editable=True, max_length=3)
    sap_id = models.IntegerField('Sap ID', null=False, blank=False, editable=True, )
    name = models.CharField('Name', null=True, blank=True, editable=True, max_length=64)
    stawka = models.DecimalField('Stawka', null=True, blank=True, editable=True, decimal_places=2,max_digits=12)
    czas = models.CharField('Czas', null=False, blank=False, editable=True, max_length=16)
    czas_noc = models.CharField('Czas nocki', null=False, blank=False, editable=True, max_length=16)
    czas_nadl50 = models.CharField('Czas nadliczbowe 50%', null=False, blank=False, editable=True, max_length=16)
    czas_nadl100 = models.CharField('Czas nadliczbowe 100%', null=False, blank=False, editable=True, max_length=16)
    

    
admin.site.register(Cuw)


class Oddz( models.Model):
    
    class Meta:
        verbose_name = _("Oddział")
        verbose_name_plural = _("Oddziały")
        default_permissions = ('add', 'change', 'delete', 'list')
        app_label = 'produkcja'
    ...
    month = models.IntegerField('Month', null=False, blank=False, editable=True, )
    mag = models.CharField('Magazyn', null=False, blank=False, editable=True, max_length=3)
    godz_obce = models.FloatField('Godziny obce', null=True, blank=True, editable=True, )
    naj_wyn = models.FloatField('Najniższe wynagrodzenie', null=True, blank=True, editable=True, )
    il_rbg = models.FloatField('Ilość roboczogodzin', null=True, blank=True, editable=True, )
    

    
admin.site.register(Oddz)
