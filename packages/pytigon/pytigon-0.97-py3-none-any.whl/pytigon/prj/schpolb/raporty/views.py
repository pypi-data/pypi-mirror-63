...
(    select Mag, SymKar, SymCech, OpiKar, Stan, 
    ...
    where stany.Stan > 0 and ( mag like '__' or mag like '[123456]__')
) stany2
...
where (stany2.Mag like '__' or stany2.Mag like '[123456]__') and stany2.Mag <> gn.Mag and gn.Mag is not NULL
order by Mag, SymKar, SymCech
"""
...
(   select SymKar, OpiKar, Stan,
    ...
    (
      ...
      (
        ...
        where stany0.mag like '__' or stany0.mag like '[123456]__'
...
class WiekowanieForm(forms.Form):
    ...
    def process(self, request, queryset=None):
        ...
        _mt = {
            'o1': "obr.Mag like '%'",
            'o2': "(obr.Mag like '__' or obr.Mag like '[56]__' ) and not obr.Mag like '50'",
...
def kwerenda(request, name):
    ...
    for key, value in request.POST.items():
        context[key] = value
    context['REMOTE_ADDR'] = request.META['REMOTE_ADDR']
