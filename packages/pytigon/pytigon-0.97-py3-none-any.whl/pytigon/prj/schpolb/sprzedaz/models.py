...
class ErpCustomer( models.Model):
    ...
    logo = models.IntegerField('Logo', null=False, blank=False, editable=True, )
    logop = models.IntegerField('Logo płatnika', null=False, blank=False, editable=True, )
    name = models.CharField('Nazwa', null=False, blank=False, editable=True, max_length=128)
    active = ext_models.NullBooleanField('Aktywny', null=True, blank=True, editable=True, )
    

    
admin.site.register(ErpCustomer)


class RetPallets( models.Model):
    
    class Meta:
        verbose_name = _("Zwrot palet")
        verbose_name_plural = _("Zwroty palet")
        default_permissions = ('add', 'change', 'delete', 'list')
        app_label = 'sprzedaz'
    ...
    parent = ext_models.ForeignKey(ErpCustomer, on_delete=models.CASCADE, null=False, blank=False, editable=True, verbose_name='Logo', )
    doc_number = models.CharField('Numer faktury', null=False, blank=False, editable=True, max_length=64)
    amount = models.IntegerField('Ilość', null=False, blank=False, editable=True, )
    warehouse = models.CharField('Magazyn', null=False, blank=False, editable=True, max_length=16)
    in_stock = ext_models.NullBooleanField('Na magazynie', null=True, blank=True, editable=True, )
    year = models.IntegerField('Z jakiego roku pochodzą palety', null=False, blank=False, editable=True, )
    description = models.TextField('Uzasadnienie', null=False, blank=False, editable=True, )
    status = models.CharField('Status', null=False, blank=False, editable=True, max_length=32)
    

    
admin.site.register(RetPallets)
