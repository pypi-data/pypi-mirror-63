...
urlpatterns = [
    ...
    gen_tab_action('ErpCustomer', 'customer_sync', views.customer_sync),
...
gen.standard('ErpCustomer', _('Klient'), _('Klienci'))
gen.standard('RetPallets', _('Zwrot palet'), _('Zwroty palet'))

gen.for_field('Nag', 'lin_set', _('Linijki'), _('Linijki'))
gen.for_field('ErpCustomer', 'retpallets_set', _('Zwrot palet'), _('Zwroty palet'))
