...
export var TEMPLATE = '        <div class=\"card\" v-bind:style=\"{ width: \'22rem\', float:\'left\', margin: \'0.2rem\' }\">\n' +
...
export var TEMPLATE3 = '        <div>\n' +
    ...
    '\n' +
    '';
export var float_from_str = function (parm) {
	return parseFloat (parm);
};
export var _calculation = function (resolve, reject) {
	var props = ['rec', 'lokalizacja', 'il_na_sam', 'cena', 'koszt', 'liczba_sam'];
	var data = function () {
...
export var _select_elem = function (resolve, reject) {
	var props = ['lp', 'category1id', 'category2id', 'category3id', 'title', 'copybutton'];
	var data = function () {
		return dict ({'category1value': '', 'category2value': '', 'category2array': [], 'category3value': '', 'category3array': [], 'ret': [], 'il_na_sam': '', 'cena': '', 'koszt': '', 'liczba_sam': '', 'category1array': [], 'mag': [], 'lokalizacja': ''});
	};
	var methods = function () {
		var changetab1 = function (id) {
			...
			this.category3value = '';
			this.ret = [];
			for (var pos of this.category1array) {
		...
		var changetab2 = function (id) {
			...
			this.category3value = '';
			this.ret = [];
			for (var pos of this.category2array) {
		...
		var changetab3 = function (id) {
			this.ret = [];
			for (var pos of this.category3array) {
	...
	var mounted = function () {
		...
		var on_open_kar = function (py_items) {
			vue_obj.category1array = [];
			for (var item of py_items) {
				vue_obj.category1array.append ([item.pathopis, item.opisgrupy, item.opikar, item.symkar]);
			}
		};
		...
		var on_open_mag = function (py_items) {
			vue_obj.mag = [];
			for (var item of py_items) {
				vue_obj.mag.append ([item.mag, item.opismag]);
			}
		};
...
export var _select_contener = function (resolve, reject) {
