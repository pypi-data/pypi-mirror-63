...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of marax-server-sdk.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = marax-server-sdk.Configuration(
    ...
    Note you can use the constants defined in the marax-server-sdk.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = marax-server-sdk.Configuration(
        signing_info = marax-server-sdk.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://<client-name>.marax.ai",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("marax-server-sdk")
