class UploadCredentials:
    def __init__(self, accessKeyId,
        ...
        self._ossInternalEndpoint = ossInternalEndpoint;
    ...
    def get_OssInternalEndpoint(self):
        return self._ossInternalEndpoint

    def set_OssInternalEndpoint(self, ossInternalEndpoint):
         self._ossInternalEndpoint = ossInternalEndpoint
