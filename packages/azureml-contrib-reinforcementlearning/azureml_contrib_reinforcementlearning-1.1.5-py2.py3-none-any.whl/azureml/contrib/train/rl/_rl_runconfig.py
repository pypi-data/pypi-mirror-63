...
class SimulatorConfiguration(_AbstractRunConfigElement):
    ...
    :param health_check_timeout: The time lapse between health checks.
    ...
    _field_to_info_dict = collections.OrderedDict([
        ...
        ("health_check_timeout", _FieldInfo(int, "The time lapse between health checks",
...
class ReinforcementLearningConfiguration(_AbstractRunConfigElement):
    ...
    def __init__(self, head_configuration, worker_configuration, simulator_configuration,
                 ...
                 queue_timeout_seconds=None, source_directory=None, _path=None, _name=None, framework=None):
    ...
    def save(self, path=None, name=None, separate_environment_yaml=False):
        ...
        * No ``path`` parameter is invalid.
        ...
        ReinforcementLearningConfiguration is saved at <path>/.azureml/<name> or <path>/aml_config/<name>.
        ...
        :param separate_environment_yaml: Indicates whether to save the Conda environment configuration.
            If True, the Conda environment configuration is saved to a YAML file named '*_environment.yml'.
    ...
    @staticmethod
    def load(path=os.getcwd(), name=None):
