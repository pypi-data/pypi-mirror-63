...
class Banks(ListoAPI):
    ...
    def upload_bank_files(self, filename, file_stream, bank=None, account_number=None, currency=None, rfc_id=None):
        return self.make_request(method="POST", path="/banks/upload_bank_files",
                                 files={'file': file_stream, filename: {
                                    "bank": bank,
