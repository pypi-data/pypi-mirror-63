...
class HomePageView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        post_promo = ArticleModel.objects.promo()[0:3]
        article_promo = ArticleModelScheme.objects.promo()[0:3]
        context['promo'] = chain(post_promo, article_promo)
        post_trending = ArticleModel.objects.promo()[0:2]
        article_trending = ArticleModelScheme.objects.promo()[0:2]
