...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of vrt_lss_routing.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = vrt_lss_routing.Configuration(
    ...
    Note you can use the constants defined in the vrt_lss_routing.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = vrt_lss_routing.Configuration(
        signing_info = vrt_lss_routing.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
