...
| Group        | STT | Name                               | Short | Year | Version   | Levy | Type   | Paras | Difficulty | Complexity |
|--------------|-----|------------------------------------|-------|------|-----------|------|--------|-------|------------|------------|
| Evolutionary | 1   | Genetic Algorithm                  | GA    | 1992 | original  | no   | weak   | 4     | easy       |            |
...
|              | 25  |                                    |       |      |           |      |        |       |            |            |
| Physics      | 1   | Wind Driven Optimization           | WDO   | 2013 | original  | no   | strong | 7     | easy       |            |
