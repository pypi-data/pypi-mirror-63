def r2e_marketing_data_presto(): 
    ...
    select 
        ...
        manual_apply_ni
    from 
        kirby_external_data.macl_data_r2e_marketing_kdd_gb_data_retainzeros
""" 
...
def test_r_data_sap_presto(label_dates_weekly, feature_date, city_ids): 
    return """
WITH label AS (
    SELECT 
        rider_uuid
