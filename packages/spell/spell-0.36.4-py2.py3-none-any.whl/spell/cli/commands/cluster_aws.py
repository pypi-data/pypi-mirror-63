...
def eks_init(ctx, cluster, auth_api_url, eks_cluster_name, nodes_min, nodes_max,
             node_volume_size, zones):
    """
    ...
    if response == "create":
        ...
        create_eks_cluster(aws_profile, eks_cluster_name, session, vpc_subnets,
                           node_private_networking, nodes_min, nodes_max, node_volume_size, zones)
    elif response == "skip":
...
def create_eks_cluster(aws_profile, cluster_name, session,
                       vpc_subnets, node_private_networking,
                       nodes_min, nodes_max, node_volume_size, zones):
