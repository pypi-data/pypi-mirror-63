"""
   ...
   51、find_overlapping：查找重叠命令。本命令用来查找有无和角色的矩形重叠的项目(包括画笔线条，圆点，填充区域，图章，其它角色)，返回找到的项目编号集合。
...
if __name__ == "__main__":  
  ...
  p =  screen._finditems()
  for i in p:
    print(i,screen.cv.type(i),screen.cv.bbox(i))
