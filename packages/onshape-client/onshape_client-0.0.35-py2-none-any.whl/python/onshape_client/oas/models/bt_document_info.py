...
try:
    from onshape_client.oas.models import bt_document_info_all_of
except ImportError:
    bt_document_info_all_of = sys.modules[
        'onshape_client.oas.models.bt_document_info_all_of']
try:
...
class BTDocumentInfo(ModelComposed):
    ...
    def discriminator():
        return {
            'json_type': {
                'BTDocumentProcessingInfo': bt_document_processing_info.BTDocumentProcessingInfo,
            },
        }
