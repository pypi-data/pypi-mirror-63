...
def FindProjectVersions(project,
    ...
    if requested_version:
        ...
        special_project_dirs.append(os.path.join(PROJECT, '%s_%s' % (PROJECT, requested_version)))

    for d in search_path:
        versions.extend(
            (project, requested_version, v, d) for v in special_project_dirs
