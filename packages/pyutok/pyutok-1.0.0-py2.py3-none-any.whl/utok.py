...
__date__ = "2020/03/14 20:19:16 hoel"
...
def utok(tokens, delimiter=":", delete_list=""):
    ...
    ----------
    - tokens : list(str) 
        List of strings representing tokens chains.
    - delimiter : str
        Character used to construct token chains.
    - delete_list : str
        Chain of tokens to be deleted from `tokens`.
