...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        n_over_k = math.factorial(self.n) / math.factorial(k) / math.factorial(self.n - k)
        return n_over_k * self.p ** k * (1 - self.p) ** (self.n - k)
    ...
    def plot_bar_pdf(self):
        ...
        x_axis = range(0, self.n + 1)
        y_axis = []
        for k in x_axis:
            y_axis.append(self.pdf(k))
