...
logger = logging.getLogger('rbx.clients.broadsign')
...
class BroadsignClient(Client):
    ...
    IF_MODIFIED_SINCE_FORMAT = 'ddd, D MMM YYYY HH:mm:ss ZZZ'
    ...
    def get_screens(self, last_modified=None, page=None):
        ...
        if last_modified:
            utc = arrow.get(last_modified, self.IF_MODIFIED_SINCE_FORMAT).to('utc')
