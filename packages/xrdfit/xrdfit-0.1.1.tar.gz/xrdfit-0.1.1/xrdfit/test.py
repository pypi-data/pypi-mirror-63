...
peak_params = [PeakParams('(10-10)', (3.02, 3.27)),
               PeakParams('(0002)(110)(10-11)', (3.3, 3.75),
                          [(3.4, 3.44), (3.52, 3.56), (3.57, 3.61)]),
...
experiment = FitExperiment(frame_time, file_string, first_cake_angle, cakes_to_fit,
                           peak_params, merge_cakes, frames_to_fit)

experiment.run_analysis(reuse_fits=True)
experiment.plot_fit_parameter("(10-10)", "maximum_1_center", show_points=True, mew=10)