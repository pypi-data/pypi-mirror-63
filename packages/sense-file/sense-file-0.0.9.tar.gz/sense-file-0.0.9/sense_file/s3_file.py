...
class S3File(object):
    ...
    def upload_content(self, file_name, content, bucket_name, publish_time=None):
        ...
        try:
            ...
            client.put_object(Bucket=bucket_name, Key=file_name,
...
if __name__ == '__main__':
    s3_file = S3File('aws')
    _path = '/Users/liuguangbin/Documents/alg/news_risk_v2019081214.tar.gz'
    print(s3_file.upload_model('news-risk/news_risk_v2019081214.tar.gz', _path, 'sdai-model', 'news-risk'))
