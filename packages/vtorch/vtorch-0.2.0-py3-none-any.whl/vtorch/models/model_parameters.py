...
class ModelParams:
    ...
    def __init__(
        self,
        transformer_config_type: str,
        transformer_model_type: str,
        ...
        self.transformer_config_type = transformer_config_type
        self.transformer_model_type = transformer_model_type
