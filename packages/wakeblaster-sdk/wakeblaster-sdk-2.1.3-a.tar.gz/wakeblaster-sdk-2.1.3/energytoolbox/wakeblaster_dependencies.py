...
class WindFarm:
    ...
    """
    def __init__(self, farm_description, wind_resource_grid=None, farm_turbulence=None):
...
class WakeBlasterDependencies:
    ...
    def set_farm(self, farm_id, wind_farm, reference_id=None, upload=True):
        ...
        if upload:
            wb.upload_asset(farm_id, wind_farm.description, wind_farm.resource_grid, wind_farm.turbulence)
