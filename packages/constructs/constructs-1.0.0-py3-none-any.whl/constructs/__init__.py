...
__jsii_assembly__ = jsii.JSIIAssembly.load("constructs", "1.0.0", __name__, "constructs@1.0.0.jsii.tgz")
...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="constructs.ConstructNode"):
    ...
    def of(cls, construct: "IConstruct") -> "ConstructNode":
    ...
    @jsii.member(jsii_name="prepareNode")
    @builtins.classmethod
    def prepare_node(cls, node: "ConstructNode") -> None:
        """Invokes "prepare" on all constructs (depth-first, post-order) in the tree under ``node``.

        :param node: The root node.
        """
        return jsii.sinvoke(cls, "prepareNode", [node])

    @jsii.member(jsii_name="synthesizeNode")
    @builtins.classmethod
    def synthesize_node(cls, root: "ConstructNode", *, outdir: str, session_context: typing.Optional[typing.Mapping[str,typing.Any]]=None, skip_validation: typing.Optional[bool]=None) -> None:
        ...
        :param session_context: Additional context passed into the synthesis session object when ``construct.synth`` is called. Default: - no additional context is passed to ``synthesizeConstruct``
        ...
        return jsii.sinvoke(cls, "synthesizeNode", [root, options])

    @jsii.member(jsii_name="validateNode")
    @builtins.classmethod
    def validate_node(cls, node: "ConstructNode") -> typing.List["ValidationError"]:
        ...
        :param node: The root node.
        """
        return jsii.sinvoke(cls, "validateNode", [node])
...
class ConstructOptions():
    def __init__(self, *, node_factory: typing.Optional["INodeFactory"]=None):
        ...
        :param node_factory: A factory for attaching ``ConstructNode``s to the construct. Default: - the default ``ConstructNode`` is associated
        """
        self._values = {
        }
...
class Construct(metaclass=jsii.JSIIMeta, jsii_type="constructs.Construct"):
    ...
    @jsii.member(jsii_name="prepareConstruct")
    def _prepare_construct(self) -> None:
        ...
        """
        return jsii.invoke(self, "prepareConstruct", [])

    @jsii.member(jsii_name="synthesizeConstruct")
    def _synthesize_construct(self, session: "ISynthesisSession") -> None:
        ...
        """
        return jsii.invoke(self, "synthesizeConstruct", [session])
    ...
    @jsii.member(jsii_name="validateConstruct")
    def _validate_construct(self) -> typing.List[str]:
        ...
        """
        return jsii.invoke(self, "validateConstruct", [])
...
class INodeFactory(jsii.compat.Protocol):
    ...
    def create_node(self, host: "Construct", scope: "IConstruct", id: str) -> "ConstructNode":
...
class ISynthesisSession(jsii.compat.Protocol):
    ...
    Passed into ``construct.synthesizeConstruct()`` methods.
    """
    @builtins.staticmethod
    def __jsii_proxy_class__():
