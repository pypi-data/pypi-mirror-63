...
class Context(object):
    ...
    @staticmethod
    def send_log_to_center(context, project="", module="", level=None, user=None, return_msg="", **kwargs):
        return send_to_log_center(context, project=project, module=module, level=level,
                                  user=user, return_msg=return_msg, **kwargs)
