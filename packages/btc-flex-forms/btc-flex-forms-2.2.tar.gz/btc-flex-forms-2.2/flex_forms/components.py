...
class PlainStaticFlexData(StaticFlexField):
    """
    Plain data interface class.
    """

    wrapper_template: str = 'flex_forms/fields/plain.html'

    def __init__(self, data: Any = '', field_group_class: str = ''):
        super().__init__(data, field_group_class=field_group_class)
...
FlexFieldType = TypeVar('FlexFieldType', BoundField, StaticFlexField, PlainStaticFlexData, FlexDataArray)
