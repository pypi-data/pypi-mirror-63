...
Usage::
    ...
    from mypy_boto3.mediaconvert.type_defs import AccelerationSettingsTypeDef

    data: AccelerationSettingsTypeDef = {...}
"""
...
AudioCodecSettingsTypeDef = TypedDict(
    "AudioCodecSettingsTypeDef",
    {
        ...
        "Codec": Literal[
            "AAC", "MP2", "MP3", "WAV", "AIFF", "AC3", "EAC3", "EAC3_ATMOS", "PASSTHROUGH"
        ],
