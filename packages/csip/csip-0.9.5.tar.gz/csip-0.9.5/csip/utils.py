"""
 * $Id: 0.9+3 utils.py 567970bec513 2019-12-06 od $
 *
...
class Client(object):
    ...
    def pubsub(self, url: str, callback = None) -> None:
        """Publish/subscribe execution """
        def cb(client: 'Client', file: str):
            pass
        ...
        if not hasattr(self, "batch"):
            raise Exception("No batch of files provided.")
        ...
        for file in glob.iglob(self._files):
