...
class connect_Flow(connect_Base):
    ...
    _hx_methods = ["setup", "step", "getAssetRequest", "getListing", "getTierConfigRequest", "getUsageFile", "setData", "getData", "approveByTemplate", "approveByTile", "fail", "inquire", "pend", "_run", "process", "processSetup", "loadStepDataIfStored", "getStepParam", "processStep", "prepareRequestAndOpenLogSection", "processAbortAndCloseLogSection", "abort", "logStepData", "getClassName"]
...
class connect_models_Model(connect_Base):
    ...
    _hx_methods = ["toObject", "toString", "_setFieldClassNames", "_toDiff", "getFieldClassName"]
    ...
    def _toDiff(self):
        ...
        diff = connect_util_Util.createObjectDiff(self.toObject(),prevObj)
        return connect_models_Model._parse(cls,diff)
...
class connect_models_Agreement(connect_models_IdModel):
    ...
    def update(self):
        agreement = connect_Env.getMarketplaceApi().updateAgreement(self.id,Reflect.field(self._toDiff(),"toString")())
        return connect_models_Model.parse(connect_models_Agreement,agreement)
...
class connect_models_AssetRequest(connect_models_IdModel):
    ...
    def update(self):
        request = connect_Env.getFulfillmentApi().updateRequest(self.id,Reflect.field(self._toDiff(),"toString")())
        return connect_models_Model.parse(connect_models_AssetRequest,request)
...
class connect_models_Listing(connect_models_IdModel):
    ...
    def put(self):
        listing = connect_Env.getMarketplaceApi().putListing(self.id,Reflect.field(self._toDiff(),"toString")())
...
class connect_models_Marketplace(connect_models_IdModel):
    ...
    def update(self):
        marketplace = connect_Env.getMarketplaceApi().updateMarketplace(self.id,Reflect.field(self._toDiff(),"toString")())
...
class connect_models_TierConfigRequest(connect_models_IdModel):
    ...
    def update(self):
        request = connect_Env.getTierApi().updateTierConfigRequest(self.id,Reflect.field(self._toDiff(),"toString")())
        return connect_models_Model.parse(connect_models_TierConfigRequest,request)
...
class connect_models_UsageFile(connect_models_IdModel):
    ...
    def update(self):
        usageFile = connect_Env.getUsageApi().updateUsageFile(self.id,Reflect.field(self._toDiff(),"toString")())
...
class connect_util_Util:
    ...
    __slots__ = ()
    _hx_statics = ["beautify", "beautifyObject", "isJson", "isJsonObject", "isJsonArray", "isArray", "isStruct", "createObjectDiff", "addIdsToObject", "compactArray"]
