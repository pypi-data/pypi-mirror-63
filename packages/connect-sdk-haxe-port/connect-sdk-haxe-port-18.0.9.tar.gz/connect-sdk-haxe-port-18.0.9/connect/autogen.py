...
class connect_models_Agreement(connect_models_IdModel):
    ...
    def update(self):
        agreement = connect_Env.getMarketplaceApi().updateAgreement(self.id,self.toString())
        return connect_models_Model.parse(connect_models_Agreement,agreement)
...
class connect_models_Listing(connect_models_IdModel):
    ...
    def put(self):
        listing = connect_Env.getMarketplaceApi().putListing(self.id,self.toString())
...
class connect_models_Marketplace(connect_models_IdModel):
    ...
    def update(self):
        marketplace = connect_Env.getMarketplaceApi().updateMarketplace(self.id,self.toString())
