...
def _put_default_dict(dict_data                 )        :
...
def _put_default_list(list_data           )        :
  """Helper function to replace RuntimeParameter with its default value."""
...
class ExecutionParameter(_ComponentParameter):
  ...
  def type_check(self, arg_name      , value     ):
    ...
    # Dict[Text, Any] <------ Okay.
    def _type_check_helper(value     , declared      ):  # pylint: disable=g-bare-generic
