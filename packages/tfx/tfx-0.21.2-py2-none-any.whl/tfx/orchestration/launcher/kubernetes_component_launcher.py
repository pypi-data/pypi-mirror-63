...
class KubernetesComponentLauncher(base_component_launcher.BaseComponentLauncher
  ...
  def _get_pod(self, core_api                  , pod_name      ,
               namespace      )                :
  ...
  def _build_pod_name(self, execution_id     )        :
