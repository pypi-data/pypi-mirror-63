...
class PlanSettings(object):
    ...
    def __init__(self, configuration='optimize_money', planning_time=20, result_ttl=20, result_timezone=0, predict_slots=0, flight_distance=False, traffic_jams=True, transport_factor=[], routing=[], local_vars_configuration=None):  # noqa: E501
