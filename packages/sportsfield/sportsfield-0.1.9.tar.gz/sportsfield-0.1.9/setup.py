...
setup(
  ...
  changes='modify the requirements, pip install matplotlip, change Soccer to soccer, change class, change in __init__, remove init, change in class name, take field out of the class,remove class',  
  install_requires=[           
          'matplotlib',
      ],
  classifiers=[
