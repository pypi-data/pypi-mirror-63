...
def load_data(path='farstail.npz', num_words=None, skip_top=0,
    ...
    path = get_file(path,
                    origin='https://raw.githubusercontent.com/m-azari/FarsTail/master/data/farstail.npz',
...
def get_word_index(path='farstail_word_index.json'):
    ...
    path = get_file(
        path,
        origin='https://raw.githubusercontent.com/m-azari/FarsTail/master/data/farstail_word_index.json',
