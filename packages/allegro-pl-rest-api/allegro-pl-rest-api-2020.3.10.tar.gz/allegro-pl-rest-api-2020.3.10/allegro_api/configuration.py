...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of allegro_api.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = allegro_api.Configuration(
    ...
    Note you can use the constants defined in the allegro_api.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = allegro_api.Configuration(
        signing_info = allegro_api.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def auth_settings(self):
        ...
        if self.access_token is not None:
            auth['bearer-token-for-application'] = {
                'type': 'oauth2',
                'in': 'header',
                'key': 'Authorization',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 2020.03.10\n"\
               "SDK Package Version: 2020.03.10".\
