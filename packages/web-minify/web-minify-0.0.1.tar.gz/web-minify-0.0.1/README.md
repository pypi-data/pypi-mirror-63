...
Turns out two major pieces were missing;
1. Support for image formats such as .png/.jpeg
2. A command line tool  that did what I expected for directories

I tried to incorporate the tool in my workflow as it was, but in the end I ended up copying the full tool source into my project and adding the features I needed out of sheer frustration. Fast worward a few months and here we are. I am polishing it into a standalone open source tool for the world to enjoy. And the rest is as they say history!
...
| Cross platform, supports many Python 3.x versions | Only tested on Pythoon 3.7 |
...
| *.jpg, *.pjeg Joint Photographic Experts Group | Seems to work | Zero |
