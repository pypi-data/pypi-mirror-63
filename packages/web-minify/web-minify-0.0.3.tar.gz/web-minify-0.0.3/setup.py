...
class ZipApp(Command):
    ...
    def run(self):
        with TemporaryDirectory() as tmpdir:
            ...
            (Path(tmpdir) / "__main__.py").write_text(
...
package = {
    ...
    "project_urls": {
        "Docs": "https://gitlab.com/firstkiss/web-minify/README.md",
        "Bugs": "https://gitlab.com/firstkiss/web-minify/-/issues",
        "C.I.": "https://gitlab.com/firstkiss/web-minify/pipelines",
    },
    ...
    "entry_points": {
        "console_scripts": ["css-html-js-minify = css_html_js_minify.minify:main"]
    },
