...
def tracer_config(kafka_uri, service_name, idc_name, set_name, instance_id, __init__, app, args, kwargs):
    """
    ...
    app.settings['kafka_reporter'] = KafkaMetricsCollector(kafka_uri, service_name, idc_name, set_name, instance_id)
