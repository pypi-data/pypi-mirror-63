...
class ScrumIntentedDevelopmentTask(ScrumDevelopmentTask):
    ...
    def create(self, element):
        try:
            ...
            self.scrum_development_task = model_factories.ScrumIntentedDevelopmentTaskFactory()
            self.scrum_development_application = application_factories.ScrumIntentedDevelopmentTaskFactory()
    ...
    def __define_priority (self):
        try:
            ...
            if priority is not None and priority is not 'None':    
                ...
                self.scrum_development_task.priority = priority.id
    ...
    def __product_backlog(self):
        try:
            ...
            if product_backlog is not None:
                self.scrum_development_task.product_backlog = product_backlog.id
            else:
    ...
    def __story_points(self):
        try:
            ...
            if story_points is not None: 
                self.scrum_development_task.story_points  = story_points
    ...
    def __activity(self):
        try:
            ...
            if activity is not None and activity is not 'None':
                ...
                self.scrum_development_task.type_activity = type_activity.id
