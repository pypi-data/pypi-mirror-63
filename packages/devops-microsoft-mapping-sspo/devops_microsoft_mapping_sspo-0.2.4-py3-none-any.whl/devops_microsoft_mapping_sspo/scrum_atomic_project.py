...
class ScrumAtomicProject(ScrumProject):
    ...
    def create(self, element, organization_id):
        try:
            ...
            self.scrum_development_task = model_factories.ScrumAtomicProjectFactory()
            self.scrum_development_application = application_factories.ScrumAtomicProjectFactory()
