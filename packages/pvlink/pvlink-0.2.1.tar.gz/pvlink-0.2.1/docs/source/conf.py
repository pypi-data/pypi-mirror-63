...
# -*- coding: utf-8 -*-
#
# pvlink documentation build configuration file
#
...
project = 'pvlink'
copyright = '2019, Juelich Supercomputing Centre (JSC)'
...
_version_py = os.path.join(repo, 'pvlink', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'pvlink.tex', 'pvlink Documentation',
