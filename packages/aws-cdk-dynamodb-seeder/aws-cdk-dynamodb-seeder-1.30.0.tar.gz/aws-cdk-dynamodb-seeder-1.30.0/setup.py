...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "ElegantDevelopment.AWSCDKDynamoDBSeeder._jsii": [
            "aws-cdk-dynamodb-seeder@1.30.0.jsii.tgz"
        ],
        "ElegantDevelopment.AWSCDKDynamoDBSeeder": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii~=0.22.0",
        "publication>=0.0.3",
        "aws-cdk.aws-dynamodb>=1.30.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.30.0, <2.0.0",
        "aws-cdk.aws-s3>=1.30.0, <2.0.0",
        "aws-cdk.aws-s3-deployment>=1.30.0, <2.0.0",
        "aws-cdk.core>=1.30.0, <2.0.0",
        "aws-cdk.custom-resources>=1.30.0, <2.0.0"
    ],
    "classifiers": [
