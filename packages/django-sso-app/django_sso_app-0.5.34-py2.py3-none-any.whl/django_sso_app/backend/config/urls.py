...
from ..views import set_language_from_url, StatsView, schema_view  # , SwaggerSchemaView
...
_I18N_URLPATTERNS += [
    path('', login_required(WebpackBuiltTemplateViewMixin.as_view(template_name='pages/home.html')), name='home'),
