...
if __name__ == '__main__':
    ...
    # plain_text = """{"timeout":60,"msg":"成功","data":{"is_match":1},"code":0}"""
    plain_text = """hellahellohellohello"""
    # 密钥
    key = 'kHSb6myV2sdtuO1n'  # 密钥长度小于等于16字节
    # key = 'qwertyuiasdfghjk'  # 密钥长度小于等于16字节

    # 加密
    cipher_text = encrypt_ecb(plain_text, key)
    # wT5V4ealnIORObQ5KRKADg==
    print('加密:',cipher_text)
    # 解密
    plain_text = decrypt_ecb("792a019035b3cec44f6ccc9965c295336f00ebaa2ff6371ebfec31984156640270447629eec9bea98021486d5d125fd0cabf68c76b6a9a0447b644093adcfa33", key)
    print('解密:',plain_text)
