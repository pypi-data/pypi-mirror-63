...
* .. image:: https://img.shields.io/pypi/dd/django-compression-middleware.svg
* .. image:: https://img.shields.io/pypi/dw/django-compression-middleware.svg
* .. image:: https://img.shields.io/pypi/dm/django-compression-middleware.svg
...
If you use the middleware, you can decorate views individually to disable
compression:

.. code:: python

    from compression_middleware.decorators import nocompress_page

    @nocompress_page
    def pdf_view(request):
        ...

This will mark the response as having a content encoding of ``identity``, i.e.
no compression. Even without the middleware, this might be useful to indicate
to intermediaries that no compression should be attempted for a particular
response.
...
Copyright (c) 2019-2020 `Friedel Wolff <https://fwolff.net.za/>`_.
