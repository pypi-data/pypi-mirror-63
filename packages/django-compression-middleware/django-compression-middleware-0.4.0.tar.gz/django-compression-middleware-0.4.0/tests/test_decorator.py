...
from compression_middleware.decorators import compress_page, nocompress_page
...
class NoCompressPageDecoratorTest(CompressPageDecoratorTest):
    ...
    def test_normal_page(self):
        ...
        self.assertTrue(r.content, self.compressible_string)
