...
class NoCompressionMiddleware(MiddlewareMixin):
    """This middleware gives a Content-Encoding of 'identity'

    This can be used (best as decorator) to indicate that a response/view
