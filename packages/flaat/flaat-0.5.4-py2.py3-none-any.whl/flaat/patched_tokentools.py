    ...
    try:
        for entry in tokenlist:
            try:
                ...
                pass
        print(str(supertoken))
        if supertoken == {}:
            return None
        return supertoken
    except Exception as e:
        print ("error in merge_tokens: {}".format(str(e)))
...
def base64url_decode(data):
    ...
    print ("base64url_decode: Type of data: {}".format(type(data)))
    print ("base64url_decode: data: {}".format(str(data)))
    # return base64.urlsafe_b64decode(data.encode('utf-8'))
    # return base64.urlsafe_b64decode(data)
    tempdata = base64.urlsafe_b64decode(data).decode()
    print ("base64url_decodde: Type of tempdata: {}".format(type(tempdata)))
    print ("base64url_decodde: data              {}".format(str(tempdata)))
    # return base64.urlsafe_b64decode(data)
...
def get_accesstoken_info(access_token):
    ...
    print("get_accesstoken_info: {}".format(header))
    print("get_accesstoken_info: {}".format(body))
