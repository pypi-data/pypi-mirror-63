...
setup(
    ...
    install_requires=['svcca @ git+ssh://git@github.com/themightyoarfish/svcca-gpu'],
    classifiers=[
    ...
    packages=['MinutiaeClassificator.ClassifyNet','MinutiaeClassificator.MinutiaeNet', 'MinutiaeClassificator.constants','MinutiaeClassificator.utils']
)