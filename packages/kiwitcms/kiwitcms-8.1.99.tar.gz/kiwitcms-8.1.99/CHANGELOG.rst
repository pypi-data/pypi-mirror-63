...
Kiwi TCMS 8.1.99 (16 Mar 2020)
------------------------------

**IMPORTANT:** this release is intended for testing purposes only. A bunch of
plugins depend on new functinality which should be present in Kiwi TCMS v8.2
and there is no way to test them in CI without having a temporary package
available on PyPI.

**Do not use this version for production purposes!**
