...
class Project():
    ...
    def remove_dataset_column_mapping(self, dataset_id, column):
        return self.client.remove_project_dataset_column_mapping(self.project_id, dataset_id, column)

    def set_dataset_column_mapping(self, dataset_id, column, column_mapping):
        return self.client.set_project_dataset_column_mapping(self.project_id, dataset_id, column, column_mapping)

    def set_dataset_column_data_type(self, dataset_id, column, data_type):
        return self.client.set_project_dataset_column_data_type(self.project_id, dataset_id, column, data_type)
