...
class ReClient():
    ...
    def remove_project_dataset_column_mapping(self, project_id: str, dataset_id: str, column: str):
        '''    '''
        return self._call_api('removeProjectDatasetColumnMapping', 'DELETE', query_params={'projectId': project_id, 'datasetId': dataset_id, 'column': column}, parse_type=ProjectDatasetSchema)

    def set_project_dataset_column_mapping(self, project_id: str, dataset_id: str, column: str, column_mapping: str):
        '''    '''
        return self._call_api('setProjectDatasetColumnMapping', 'POST', body={'projectId': project_id, 'datasetId': dataset_id, 'column': column, 'columnMapping': column_mapping}, parse_type=ProjectDatasetSchema)

    def set_project_dataset_column_data_type(self, project_id: str, dataset_id: str, column: str, data_type: str):
        '''    '''
        return self._call_api('setProjectDatasetColumnDataType', 'POST', body={'projectId': project_id, 'datasetId': dataset_id, 'column': column, 'dataType': data_type}, parse_type=ProjectDatasetSchema)
