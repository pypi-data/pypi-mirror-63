...
from tensorflow_model_analysis.types_compat import Any, Callable, Dict, Iterable, List, Optional, Text, Tuple, Union
...
def _verify_sparse_labels(labels,
                          predictions,
                          sparse_labels = None):
