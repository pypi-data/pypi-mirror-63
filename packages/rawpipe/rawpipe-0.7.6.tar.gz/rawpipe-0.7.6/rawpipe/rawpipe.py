...
class Algorithms:
    ...
    def clip(self, frame, lo=0.0, hi=1.0, verbose=True):
        """
    ...
    def bayer_combine(self, ch1, ch2, ch3, ch4):
        """
    ...
    def downsample(self, frame, iterations=1, verbose=True):
        """
    ...
    def resize(self, frame, target_width, target_height, verbose=True):
        """
    ...
    def linearize(self, frame, blacklevel=None, whitelevel=None, num_clipped=1000, verbose=True):
        """
    ...
    def demosaic(self, frame, bayer_pattern, verbose=True):
        """
    ...
    def lsc(self, frame, lscmap, verbose=True):
        """
    ...
    def wb(self, frame, gains, verbose=True):
        """
    ...
    def ccm(self, frame, matrix, verbose=True):
        """
    ...
    def tonemap(self, frame, mode="Reinhard", verbose=True):
        """
    ...
    def chroma_denoise(self, frame, strength=6, winsize=17, verbose=True):
        """
    ...
    def gamma(self, frame, mode="sRGB", lut=None, verbose=True):
        """
    ...
    def quantize(self, frame, maxval, dtype=np.uint16, verbose=True):
        """
