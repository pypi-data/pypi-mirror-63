...
def is_cdf_valid(data, version='latest', raise_error=False, full_output=False):
    ...
    >>> with open('tests/_test_data/cdf_correct_v0.1.cdf') as s: data = safe_load(s)
    >>> is_cdf_valid(data, version='0.1', raise_error=False)
    True

    >>> with open('tests/_test_data/cdf_correct_v0.1.cdf') as s: data = safe_load(s)
    >>> is_cdf_valid(data, version='0.2', raise_error=False)
    False
    ...
    >>> with open('tests/_test_data/cdf_correct_v0.2.cdf') as s: data = safe_load(s)
    >>> is_cdf_valid(data, raise_error=False)
    False
    ...
    >>> with open('tests/_test_data/cdf_correct_v0.3.cdf') as s: data = safe_load(s)
    >>> is_cdf_valid(data, raise_error=False)
    True
