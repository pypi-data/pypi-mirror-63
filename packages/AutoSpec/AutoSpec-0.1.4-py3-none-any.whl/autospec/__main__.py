...
class Controller():
    ...
    def process_cmd(self):
        ...
        self.log('Start process handler')
...
class CommandHandler():
    def __init__(self, controller, title='Working...', label='Working...', buttons={}, timeout=3000):
        self.controller=controller
    ...
    def timeout(self, log_string=None, retry=True, dialog=True, dialog_string='Error: Operation timed out'):
        ...
        if log_string==None:
            self.controller.log('Error: Commanded operation timed out.')
        else:
...
class DataHandler(CommandHandler):
    def __init__(self, controller, title='Transferring data...',label='Tranferring data...', source=None, temp_destination=None, final_destination=None):
        self.listener=controller.spec_listener
        super().__init__(controller, title, label, timeout=2*BUFFER+6000)
        self.source=source
    ...
    def wait(self):
        ...
        self.timeout(log_string='Error: Data transfer operation timed out.')
