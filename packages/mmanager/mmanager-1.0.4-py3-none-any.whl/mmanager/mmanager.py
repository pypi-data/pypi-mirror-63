    ...
    def post_model(self, model_data):
        ...
        try:
            ...
            if os.path.exists(model_file_path):
                ...
                print("Path Specified for model_file_path is invalid")
                return
        except:
            model_file = None
        ...
        try:
            ...
            if os.path.exists(scoring_file_path):
                scoring_file = open(scoring_file_path, 'rb')
            else:
                print("Path Specified for scoring_file_path is invalid")
                return
        except:
            scoring_file = None
        ...
        files = {
            ...
            "scoring_file_path": scoring_file,
        }
