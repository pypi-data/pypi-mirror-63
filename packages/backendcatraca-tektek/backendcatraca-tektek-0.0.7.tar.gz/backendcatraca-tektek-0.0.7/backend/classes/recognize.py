...
from backend.classes.utils import Utils
from backend.classes.personmanager import PersonManager

DETECTION_METHOD='hog'
API_ADDRESS = 'http://briansilva1.zeedhi.com/workfolder/integracao-catraca/backend/service/index.php'
