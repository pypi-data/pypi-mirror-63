...
class fii:
    ...
    def __init__(self, _lst_fiis, _lst_proventos, _registros, _dict_preferencial):
        ...
        for ticker in {k: dic_estrutura[k] for k in list(dic_estrutura)[:_registros]}:
            ...
            data_ultimo_preco = datetime.datetime.strptime(html[posicao_palavra_fechamento + 17:posicao_palavra_fechamento + 27], "%d/%m/%Y")
            ...
            if estrutura[1] != 'Ops! Algo está errado...':
                lst_fiis_interno[int_pointer].data_ultimo_preco = data_ultimo_preco
                ...
                lst_fiis_interno[int_pointer].data_constituicao = datetime.datetime.strftime(str_data_constituicao,"%d/%m/%Y")
