...
{'': ['*'],
 'cms': ['fixtures/*',
         ...
         'templates/*',
         'templates/cms/*'],
 'importer': ['fixtures/*', 'locale/de/LC_MESSAGES/django.po'],
 'mainapp': ['fixtures/.gitignore',
             'fixtures/.gitignore',
             'fixtures/.gitignore',
             'fixtures/.gitignore',
             'fixtures/.gitignore',
             'fixtures/.gitignore',
             'fixtures/cologne-pois-test.json',
             'fixtures/cologne-pois-test.json',
             'fixtures/cologne-pois-test.json',
             'fixtures/cologne-pois-test.json',
             'fixtures/cologne-pois-test.json',
             'fixtures/cologne-pois-test.json',
             'fixtures/dummy_admin.json',
             'fixtures/dummy_admin.json',
             'fixtures/dummy_admin.json',
             'fixtures/dummy_admin.json',
             'fixtures/dummy_admin.json',
             ...
             'fixtures/search.json',
             'fixtures/search.json',
             'fixtures/socialapps.template.json',
             'fixtures/socialapps.template.json',
             'fixtures/socialapps.template.json',
             'fixtures/socialapps.template.json',
             'fixtures/socialapps.template.json',
