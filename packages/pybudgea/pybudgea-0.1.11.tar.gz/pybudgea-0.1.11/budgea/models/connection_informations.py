...
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=false, isContainer=true, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=true, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=true, _enum=null, allowableValues=null, items=CodegenProperty{openApiType='Connection', baseName='connections', complexType='Connection', getter='getConnections', setter='setConnections', description='null', dataType='Connection', datatypeWithEnum='Connection', dataFormat='null', name='connections', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.connections;', baseType='Connection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='budgea.models.connection.Connection(
                    accounts = [
                        budgea.models.connection_account.ConnectionAccount(
                            balance = 1.337, 
                            bic = '0', 
...
class ConnectionInformations(object):
    ...
    def __init__(self, connections=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated = ConnectionInformationsSchema().load({
                'connections': connections,
                'total': total
            })
