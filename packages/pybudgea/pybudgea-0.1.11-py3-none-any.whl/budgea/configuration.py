...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of budgea.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the budgea.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = budgea.Configuration(
        signing_info = budgea.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
