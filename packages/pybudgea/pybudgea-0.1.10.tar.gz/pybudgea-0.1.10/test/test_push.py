...
import budgea
from budgea.models.push import Push  # noqa: E501
from budgea.rest import ApiException

class TestPush(unittest.TestCase):
    """Push unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = budgea.models.push.Push()  # noqa: E501
        if include_optional :
            return Push(
                connection = budgea.models.connection.Connection(
                    accounts = [
                ...
                push_type = '0', 
                user = budgea.models.user.User(
                    id = 56, 
                    platform = 'web', 
                    signin = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
            )
        else :
            return Push(
        )
