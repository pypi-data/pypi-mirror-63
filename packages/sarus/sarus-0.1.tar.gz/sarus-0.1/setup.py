...
setup(
  ...
  description = 'Python client for the Sarus Gateway. Users can explore & train AI models on sensitive data, via synthetic data browsing, remote training and differential privacy.',   # Give a short description about your library
