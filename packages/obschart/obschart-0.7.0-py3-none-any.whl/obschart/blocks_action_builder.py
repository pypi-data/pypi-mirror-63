class BlocksActionBuilder(object):
    ...
    def add_text_field(self, title: str, required: bool = False):
        return self.add_block({"type": "textField", "title": title, "required": required,})

    def add_image_field(self, title: str, required: bool = False):
        return self.add_block({"type": "imageField", "title": title, "required": required,})

    def add_date_time_field(self, title: str, required: bool = False):
        return self.add_block({"type": "dateTimeField", "title": title, "required": required,})

    def add_scale_field(
        self, title: str, required: bool = False, min: int = 0, max: int = 10, step: int = 1,
    ):
