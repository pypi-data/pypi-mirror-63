...
from pytket import Circuit, OpType, CircBox
...
ControlWire = NamedTuple('ControlWire', [
    ('wire', Wire),
    ('negative', bool)
    ])
...
class QuipperTransformer(Transformer):
    ...
    def pos_control_wire(self, t):
        return ControlWire(t[0], False)
    control_wire_list = list
    def neg_control_wire(self, t):
    ...
    def make_circuit(self, circ):
        ...
        for gate in gates:
            ...
            # Not supported in pytket.
                ...
                raise TypeError("Unknown gate type: %s" % gtype)
        return c
...
def circuit_from_quipper(input_file:str) -> Circuit:
    ...
    * No support for classical operations ('CNot', 'CGate', 'CSwap', 'CInit',
    ...
    x = Lark("""
        ...
        int : INT
        """,
        parser='lalr', transformer=QuipperTransformer()).parse(quip)
