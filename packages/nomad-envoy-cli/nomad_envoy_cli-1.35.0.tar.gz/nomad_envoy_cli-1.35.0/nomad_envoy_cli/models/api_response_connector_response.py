...
class ApiResponseConnectorResponse(object):
    ...
    def __init__(self, input=None, mapping_name=None, api=None, api_doc_link=None, http_request_raw_data=None, code=None, response=None, response_en=None, platform=None, request_count=None, response_time=None):  # noqa: E501
