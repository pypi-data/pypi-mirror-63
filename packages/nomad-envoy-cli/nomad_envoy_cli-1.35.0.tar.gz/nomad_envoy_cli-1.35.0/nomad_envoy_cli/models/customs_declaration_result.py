...
class CustomsDeclarationResult(object):
    ...
    def __init__(self, region=None, declaration_type=None, declaration_number=None, client_order_ref=None, order_id=None, product_sku_number=None, product_barcode=None, orig_message=None, is_regsitered=None):  # noqa: E501
