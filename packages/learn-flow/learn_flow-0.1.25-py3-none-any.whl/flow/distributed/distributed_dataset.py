...
from ..callbacks import on_epoch_begin, before_session_initialization, on_validate_begin
from blinker import signal


class DistributedDataset(object):

    def __init__(self, partitions:dict, inputs_config, config: Config=None, *args, **kwargs):
        # configurations
