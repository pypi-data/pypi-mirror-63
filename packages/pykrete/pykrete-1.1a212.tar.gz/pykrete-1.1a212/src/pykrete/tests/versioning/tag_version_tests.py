...
class PykreteVersioningTagVersionTestCase(PykreteVersioningTestCase):
    ...
    def test_tag_version_local_release_two_minor_bumps(self):
        """Verifies handling of simulated two minor bumps after a previous release
        on release where only one minor bump should be used
        """
        self._assert_tag_version_local(
            spec=self._make_release_spec_for_build('12345'),
            tags=[('11.22.341', 'ci_base_build 12338'), ('bump_minor', None), ('bump_minor', None)],
            expected_version=Version((11, 23, 4, 0, RevisionType.Release)))
    ...
    def test_tag_version_local_release_two_major_bumps(self):
        ...
        """
        self._assert_tag_version_local(
            spec=self._make_release_spec_for_build('88888'),
    ...
    def _assert_tag_version_local(self, spec, tags, expected_version):
        self.__tags = tags
