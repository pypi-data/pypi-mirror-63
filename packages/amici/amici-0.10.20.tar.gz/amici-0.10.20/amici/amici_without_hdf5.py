...
class SolverPtr(object):
    ...
    def getDiagnosis(self, it: "int", rdata: "ReturnData") -> "void":
        r"""
    ...
    def getDiagnosisB(self, it: "int", rdata: "ReturnData", which: "int") -> "void":
        r"""
        Extracts diagnosis information from solver memory block and
...
class ReturnDataPtr(object):
    ...
    def applyChainRuleFactorToSimulationResults(self, model: "Model") -> "void":
        r"""
        applies the chain rule to account for parameter transformation in
    ...
    def fres(self, it: "int", edata: "ExpData") -> "void":
        r"""
        Residual function
        :type it: int
        :param it: time index
    ...
    def fsres(self, it: "int", edata: "ExpData") -> "void":
        r"""
...
class ConditionContext(object):
    ...
    def __init__(self, model: "Model", edata: "ExpData"=None):
        r"""
    ...
    def applyCondition(self, edata: "ExpData") -> "void":
        r"""
...
class Model(AbstractModel):
    r"""
    The Model class represents an AMICI ODE model. The model can compute
