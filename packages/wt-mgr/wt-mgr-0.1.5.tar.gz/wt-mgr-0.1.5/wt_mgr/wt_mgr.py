...
async def wt_mgr():
    ...
    # Teams
    if teams_file_path:
        logger.info(f"Importing teams config: {teams_file_path}")
    ...
    # Rooms
    if rooms_file_path:
        logger.info(f"Importing rooms config: {rooms_file_path}")
    ...
    if teams_users_file_path:
        logger.info(f"Importing teams users config: {teams_users_file_path}")
