...
class NestDisplay(object):
    ...
    def ustring(self, indent, color, msg, prefix="", suffix="", endc=attr(0)):
    ...
    def display(self, ret, indent, prefix, out):
        ...
        if ret is None or ret is True or ret is False:
            out.append(self.ustring(indent, fg(11), ret, prefix=prefix))
        ...
        # as until about python32 it was limited to 12 digits only by default
            ...
            out.append(self.ustring(indent, fg(11), repr(ret), prefix=prefix))
            ...
            for line in ret.splitlines():
                ...
                if isinstance(line, bytes):
                    ...
                    break
                out.append(self.ustring(indent, fg(2), line, prefix=line_prefix))
                first_line = False
