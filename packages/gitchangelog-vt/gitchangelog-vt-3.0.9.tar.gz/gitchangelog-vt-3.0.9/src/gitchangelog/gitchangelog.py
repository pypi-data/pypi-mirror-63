...
__version__ = "3.0.9"  ## replaced by autogen.sh
...
def versions_data_iter(repository, revlist=None,
    ...
    for idx, tag in enumerate(tags):
        ...
        for commit in commits:
            ...
            ## When the method 'send_parser' isn't implement in the personal modules
...
## When the method 'see_request_filter' isn't implement in the personal modules.
