...
def get_super_parameters(base_price, base_time):
    ...
    delta = delta =1/(252*24)
    super_params = ModelParameters(
        all_s0=base_price,
        all_r0=0.001,
        all_time=base_time,
        all_delta=delta,
        all_sigma=random.normalvariate(0.4, 0.15),
        gbm_mu=random.normalvariate(0.1, 0.3),
        jumps_lamda=random.normalvariate(0.03, 0.1),
        jumps_sigma=random.normalvariate(0.02, 0.007),
        jumps_mu=random.normalvariate(0.01, 0.05),
        cir_a=3.0,
        cir_mu=0.5,
        cir_rho=0.5,
        ou_a=3.0,
