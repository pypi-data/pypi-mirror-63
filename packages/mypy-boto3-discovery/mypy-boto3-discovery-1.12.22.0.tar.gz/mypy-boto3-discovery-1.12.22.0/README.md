...
[boto3.ApplicationDiscoveryService 1.12.22](https://boto3.amazonaws.com/v1/documentation/api/1.12.22/reference/services/discovery.html#ApplicationDiscoveryService) service
