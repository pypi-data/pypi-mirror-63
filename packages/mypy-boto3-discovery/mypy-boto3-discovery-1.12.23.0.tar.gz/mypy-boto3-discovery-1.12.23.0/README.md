...
[boto3.ApplicationDiscoveryService 1.12.23](https://boto3.amazonaws.com/v1/documentation/api/1.12.23/reference/services/discovery.html#ApplicationDiscoveryService) service
