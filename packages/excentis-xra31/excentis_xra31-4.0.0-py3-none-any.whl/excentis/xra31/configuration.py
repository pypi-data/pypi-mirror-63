...
class Detection(core.ChannelList):
    ...
    def wait_for_channel(self,
                         ...
                         *,
                         ...
                         ucid: int = -1,
                         frequency: float = 0.,
                         timeout: float = None) -> core.UpstreamChannel:
...
class Configuration(core.ChannelList):
    ...
    def add_ofdm(self,
        ...
        :param rolloff_period: Roll-off period, defaults to 0.
        :type rolloff_period: int, optional
    ...
    def wait_for_state(self,
        ...
        while not channel or channel.state != state and (
            ...
            channel = self.find(channel_parameters,
                                ...
                                ucid=ucid,
                                frequency=frequency)
        return channel and channel.state == state
    ...
    def apply(self,
        ...
        if downstream:
            if "annex" in description:
                ...
                self.xra31.logger.info("Set core.Annex to " + str(annex))
                self.annex = annex
            ...
            if str(core.ChannelType.OFDM) in description:
                ...
                for channel_parameters in description[str(
                    ...
                    self.add_ofdm(channel_parameters["plc_frequency"],
                                  ...
                                  channel_parameters["rolloff_period"])
