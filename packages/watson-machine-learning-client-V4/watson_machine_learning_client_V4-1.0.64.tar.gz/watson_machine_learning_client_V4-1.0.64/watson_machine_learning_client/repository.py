...
class Repository(WMLResource):
    ...
    def get_model_revision_details(self, model_uid, rev_uid):
        """
           Get metadata of stored model revision.

           **Parameters**

           .. important::
                #. **model_uid**: Unique Id of the Model\n
                   **type**: str\n

                 #. **model_uid**: Unique revision Id \n
                   **type**: str\n
           **Output**

           .. important::
                **returns**: metadata of model revision\n
                **return type**: dict
           **Example**

            >>> model_revision_details = client.repository.get_model_revision_details(model_uid, rev_uid)
        """
    ...
    def get_experiment_revision_details(self, experiment_uid, rev_id):
        """
           Get metadata of stored experiment.
           ...
           **Parameters**
           ...
           .. important::
                #. **experiment_uid**: Experiment UID\n
                 ...
                 #. **rev_uid**: Revision UID of the experiment\n
                   **type**: str\n

           **Output**

           .. important::
                **returns**: metadata of experiments revision\n
                **return type**: dict
           **Example**

            >>> experiment_revision_details = client.repository.get_experiment_revision_details(experiment_uid)
        """
        if not self._client.ICP_30:
            raise WMLClientError(
    ...
    def get_function_revision_details(self, function_uid, rev_id):
        """
           Get metadata of stored function revision.

           **Parameters**

           .. important::
                #. **experiment_uid**: Unique Id of function. \n
                   **type**: str\n

                 #. **rev_uid**: Revision UID of the function\n
                   **type**: str\n

           **Output**

           .. important::
                **returns**: metadata of function revision\n
                **return type**: dict
           **Example**

            >>> function_revision_details = client.repository.get_function_revision_details(function_uid)
        """
        if not self._client.ICP_30:
            raise WMLClientError(
                'Not supported. Revisions APIs are supported only for WML Cloud Pack for Data 3.0 and above.')
    ...
    def get_pipeline_revision_details(self, pipeline_uid, rev_id):
        """
           ...
           **Parameters**
           ...
           .. important::
                #. **experiment_uid**: Unique Id of pipeline. \n
                   **type**: str\n

                 #. **rev_uid**: Revision UID of the pipeline\n
                   **type**: str\n

           **Output**

           .. important::
                **returns**: metadata of pipeline revision\n
                **return type**: dict
           **Example**

            >>> pipeline_revision_details = client.repository.get_pipeline_revision_details(pipeline_uid)
        """
        if not self._client.ICP_30:
            raise WMLClientError(
                'Not supported. Revisions APIs are supported only for WML Cloud Pack for Data 3.0 and above.')
