...
class SwSpec(WMLResource):
    ...
    def get_details(self,sw_spec_uid=None):
        """
            ...
            **Example**
             ...
             >>> sw_spec_details = client.sofware_specifications.get_details(sw_spec_uid)
        """
    ...
    def store(self, meta_props):
        """
                ...
                **Parameters**
                ...
                .. important::
                   #. **meta_props**:  meta data of the space configuration. To see available meta names use:\n
                                    >>> client.sofware_specifications.ConfigurationMetaNames.get()
                ...
                **Example**
                 ...
                 >>> meta_props = {
                 >>>    client.sofware_specifications.ConfigurationMetaNames.NAME: "skl_pipeline_heart_problem_prediction",
                 >>>    client.sofware_specifications.ConfigurationMetaNames.DESCRIPTION: "description scikit-learn_0.20",
                 >>>    client.sofware_specifications.ConfigurationMetaNames.PACKAGE_EXTENSIONS_UID: [],
                 >>>    client.sofware_specifications.ConfigurationMetaNames.SOFTWARE_CONFIGURATIONS: {},
                 >>>    client.sofware_specifications.ConfigurationMetaNames.BASE_SOFTWARE_SPECIFICATION_ID: "guid"
                 >>> }
    ...
    def list(self,name=None):
        """
           ...
           **Example**
            ...
            >>> client.sofware_specifications.list()
        """
    ...
    def get_uid(sw_spec_details):
        """
                Get UID of software specification.

                **Parameters**

                .. important::

                   #. **asset_details**:  Metadata of the software specification\n
                      **type**: dict\n
                      **type**: dict\n
                ...
                **Example**
                 ...
                 >>> asset_uid = client.sofware_specifications.get_uid(sw_spec_details)
        """
    ...
    def get_uid_by_name(self, sw_spec_name):
        """
                ...
                **Example**
                 ...
                 >>> asset_uid = client.sofware_specifications.get_uid_by_name(sw_spec_name)
        """
    ...
    def get_href(sw_spec_details):
        """
           ...
           **Example**
             ...
             >>> sw_spec_details = client.sofware_specifications.get_details(sw_spec_uid)
             >>> sw_spec_href = client.sofware_specifications.get_href(sw_spec_details)
        """
        SwSpec._validate_type(sw_spec_details, u'sw_spec_details', object, True)
        SwSpec._validate_type_of_details(sw_spec_details, SW_SPEC_DETAILS_TYPE)
    ...
    def delete(self, sw_spec_uid):
        """
            ...
            **Parameters**
            ...
            .. important::
                #. **sw_spec_uid**:  software specifications UID\n
                   **type**: str\n
            ...
            **Example**
             ...
             >>> client.sofware_specifications.delete(sw_spec_uid)
        """
        SwSpec._validate_type(sw_spec_uid, u'sw_spec_uid', STR_TYPE, True)
    ...
    # @docstring_parameter({'str_type': STR_TYPE_NAME})
    # def update(self, sw_spec_uid, changes):
    #     """
    ...
    #
    #     details = self._client.software_specifications.get_details(sw_spec_uid)
    #
    ...
    #
    #     updated_details = self._handle_response(200, u'sw spec patch', response)
    #
    ...
    def add_package_extension(self, sw_spec_uid, pkg_extn_id):
        """
                Add a package extension to software specifications existing pipeline metadata.

                **Parameters**

                .. important::

                    #. **sw_spec_uid**:  UID of software specification which should be updated\n
                       **type**: str\n
                    #. **pkg_extn_id**:  UID of package extension which should needs to added to software specification\n
                       **type**: str\n
        ...
        """
                ...
                **Parameters**
                ...
                .. important::
                    ...
                    #. **sw_spec_uid**:  UID of software specification which should be updated\n
                       **type**: str\n
                    #. **pkg_extn_id**:  UID of package extension which should needs to deleted from software specification\n
                       **type**: str\n
