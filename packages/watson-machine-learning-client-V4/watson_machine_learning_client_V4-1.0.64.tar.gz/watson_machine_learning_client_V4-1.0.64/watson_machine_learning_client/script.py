...
class Script(WMLResource):
    ...
    def get_details(self,asset_uid):
        """
            ...
            **Parameters**
            ...
            .. important::
                #. **scripts_details**:  Metadata of the stored script asset\n
                   **type**: dict\n
            ...
            **Example**
             ...
             >>> asset_details = client.Scripts.get_details(asset_uid)
        """
    ...
    def store(self, meta_props, file_path):
        """
                ...
                **Example**
                 >>> asset_details = client.data_assets.store(meta_props,file_path="/path/to/file")
        """
