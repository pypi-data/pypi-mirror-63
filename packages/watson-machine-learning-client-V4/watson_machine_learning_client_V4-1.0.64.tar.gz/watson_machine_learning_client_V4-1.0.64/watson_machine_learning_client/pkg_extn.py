    ...
    def store(self, meta_props, file_path):
        """
                ...
                **Example**
                 ...
                 >>>    client.package_extensions.ConfigurationMetaNames.TYPE: "conda_yml/custom_library",
                 >>> }
                **Example**
        ...
        if creation_response.status_code == 201:
            ...
            if put_response.status_code == 201:
                ...
                if complete_response.status_code == 204:
                    ...
                    self._delete(pkg_extn_id)
                    raise WMLClientError("Failed while creating a package extensions. Try again.")
            else:
                self._delete(pkg_extn_id)
                raise WMLClientError("Failed while creating a package extensions. Try again.")
        else:
    ...
    def delete(self, pkg_extn_uid):
        """
            ...
            **Parameters**
            ...
            .. important::
                #. **pkg_extn_uid**:  package extension UID\n
                   **type**: str\n
    ...
    def download(self, pkg_extn_id, filename):
        """
            ...
            **Parameters**
            ...
            .. important::
                 #. **pkg_extn_uid**:  The UID of the package extension to be downloaded\n
                    **type**: str\n
        ...
        Assets._validate_type(pkg_extn_id, u'pkg_extn_id', STR_TYPE, True)
