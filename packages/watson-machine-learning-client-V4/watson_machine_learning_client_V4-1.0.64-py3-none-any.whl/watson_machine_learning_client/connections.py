...
class Connections(WMLResource):
    ...
    def list_datasource_types(self,limit=None):
        """
           List stored datasource types assets. If limit is set to None there will be only first 50 records shown.
        ...
        self._list(space_values, [u'NAME', u'DATASOURCE_ID', u'TYPE', u'STATUS'], None, _DEFAULT_LIST_LENGTH)

    def list(self, limit=None):
        """
           List all stored connections. If limit is set to None there will be only first 50 records shown.
        ...
        self._list(space_values, [u'NAME', u'ID', u'CREATED',  u'DATASOURCE_TYPE_ID', ], None, _DEFAULT_LIST_LENGTH)
