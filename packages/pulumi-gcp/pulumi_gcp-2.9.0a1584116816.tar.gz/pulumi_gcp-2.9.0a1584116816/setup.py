...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.9.0-alpha.1584116816+ga56f7d69'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.9.0-alpha.1584116816+ga56f7d69`
                """)
            else:
                raise
