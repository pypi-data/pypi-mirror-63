...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.9.0-alpha.1583862007+g2d5b2c58'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.9.0-alpha.1583862007+g2d5b2c58`
                """)
            else:
                raise
