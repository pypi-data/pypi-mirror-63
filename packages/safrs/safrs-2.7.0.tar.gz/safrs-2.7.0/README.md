...
Access Control can be implemented by applying decorators to the endpoints generated by the `expose_objects` method.
Documentation and examples can be found in the [wiki](https://github.com/thomaxxl/safrs/wiki/Access-Control)
