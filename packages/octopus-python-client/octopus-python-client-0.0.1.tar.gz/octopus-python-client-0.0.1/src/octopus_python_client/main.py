...
def run():
    ...
    if args.space_id_name:
        ...
        if space_id:
            ...
            print(f"the space id/name {args.space_id_name} you specified does not exist")
            return
    else:
    ...
    if args.dst_space_id_name:
        ...
        if dst_space_id:
            ...
            print(f"the destination space id/name {args.dst_space_id_name} you specified does not exist")
            return
