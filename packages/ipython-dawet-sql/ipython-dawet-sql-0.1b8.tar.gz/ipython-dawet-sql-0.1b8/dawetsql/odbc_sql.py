...
import re
import os
from pandas import read_sql, concat, ExcelWriter
...
class OdbcSqlMagics(Magics):
    ...
    def odbc_reconnect(self, args=None, cell=None):
        ...
        return self.connect(self.__dsn, self.__user, password, connection_string, verbose=False)
    ...
    def odbc_sql(self, arg, cell=None, local_ns=None):
        ...
        placeholders = re.findall(r'(\?[a-zA-Z0-9]+)', cell, re.DOTALL)
    ...
    def to_excel(self, query, filename):
        ...
        raise Exception("Not Impelentet!")
