...
class MQTT_csv_saver:
    ...
    def __init__(self, channels_to_use, filepath, mqtt_port, mqtt_ip, mqtt_topic="pydslog/0/in/", json_index="payload", frequency=None, filename=None, labeled=False, save_as_signal=False,
                 header=True, custom_header=None, add_tmp=None, date_format="%d/%m/%Y,%H:%M:%S", w_mode="a", delimiter=","):
