...
class mqtt_test_3(unittest.TestCase):
    ...
    def test_format_csv(self):
        ...
        with patch('PyDSlog.csv.MQTTLogger.time') as mock_ms:
    ...
    def test_header(self):
        ...
        h = "ms,VAL1,VAL2,VAL3,VAL4,VAL6,VAL5,label\n"
...
class mqtt_test_4(unittest.TestCase):
    ...
    def test_format_csv(self):
        ...
        with patch('PyDSlog.csv.MQTTLogger.datetime') as mock_ms:
            n = datetime.now()
    ...
    def test_header(self):
        ...
        h = "date,time,VAL1,VAL2,VAL3,VAL4,VAL6,VAL5,label\n"
...
class mqtt_test_5(unittest.TestCase):
    ...
    def test_header(self):
        ...
        h = "us,VAL1,VAL2,VAL3,VAL4,VAL6,VAL5,label\n"
