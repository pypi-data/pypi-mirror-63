...
def deriv_data(names, width=60, median=None,
    ...
    for i, old in enumerate(old_names):
        ...
        if new != old:
            pytplot.data_quants[new] = pytplot.data_quants[old].copy()

        data = pytplot.data_quants[new]
        data = data.differentiate('time')
