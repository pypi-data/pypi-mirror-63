# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-10 18:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cropping', image_cropping.fields.ImageRatioField('image', '120x100', adapt_rotation=False, allow_fullsize=True, free_crop=False, help_text=None, hide_image_field=False, size_warning=False, verbose_name='cropping')),
                ('cropping_free', image_cropping.fields.ImageRatioField('image', '300x300', adapt_rotation=False, allow_fullsize=False, free_crop=True, help_text=None, hide_image_field=False, size_warning=True, verbose_name='cropping free')),
                ...
                ('phone_number', models.CharField(blank=True, max_length=16, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex=b'^\\+\\d{8,15}$')])),
                ...
                ('editByGoogle', models.BooleanField(default=False, verbose_name="Google Edit User's Info")),
                ('google_isPlusUser', models.BooleanField(default=False, verbose_name='Google Plus')),
                ('google_plusUrl', models.URLField(blank=True, max_length=500, verbose_name='Google Plus Page')),
                ('google_circledByCount', models.IntegerField(blank=True, default=0, verbose_name='Google Circle byCount')),
                ('google_language', models.CharField(blank=True, max_length=2, verbose_name='Google Language')),
                ('google_kind', models.CharField(blank=True, max_length=2, verbose_name='Google Kind')),
                ('google_verified', models.BooleanField(default=False, verbose_name='Google Verified')),
            ],
            options={
                'ordering': ['username'],
                'abstract': False,
