...
from itertools import repeat, compress, accumulate, filterfalse
...
class Series(list):
    ...
    def __getslice__(self, start, stop):
        return Series(list.__getslice__(self, start, stop), self.nan)
    ...
    def diff(self, lag):
        ...
        return Series((getter(self, i) - getter(self, i - lag) for i in range(lag, len(self))), self.nan)
