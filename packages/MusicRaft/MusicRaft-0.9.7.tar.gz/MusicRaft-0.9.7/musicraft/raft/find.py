...
class Find(QtWidgets.QDialog):
    ...
    def find(self):
        ...
        text = self.parent.currentWidget().toPlainText()
        ...
        if self.lastMatch:
            ...
            self.parent.currentWidget().moveCursor(QtWidgets.QTextCursor.End)

    def replace(self):

        # Grab the text cursor
        cursor = self.parent.currentWidget().textCursor()
        ...
        if self.lastMatch and cursor.hasSelection():
            ...
            self.parent.currentWidget().setTextCursor(cursor)
