...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/core", "1.29.0", __name__, "core@1.29.0.jsii.tgz")
...
class IConstruct(constructs.IConstruct, jsii.compat.Protocol):
...
class _IConstructProxy(jsii.proxy_for(constructs.IConstruct)):
    """Represents a construct."""
