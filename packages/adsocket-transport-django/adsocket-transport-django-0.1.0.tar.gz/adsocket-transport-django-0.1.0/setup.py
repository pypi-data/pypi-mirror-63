...
with open('adsocket_transport_django/version.py', 'r') as fd:
...
setup(
    ...
    packages=['adsocket_transport_django'],
    zip_safe=True,
    include_package_data=True,
    platforms='any',
    license='MIT',
    description="ADSocket transport library with Django integration",
