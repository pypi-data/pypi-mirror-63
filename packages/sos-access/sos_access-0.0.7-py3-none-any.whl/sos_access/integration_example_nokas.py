...
#result = client.send_alarm(event_code='', detector='1',
#                           detector_text='detector',
#                            transmitter_area='1', reference='test', section='1',
