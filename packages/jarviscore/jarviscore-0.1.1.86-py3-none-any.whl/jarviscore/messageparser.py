...
def __parse_usernotice(line: str) -> UserNotice:
    ...
    if notice_type in ("sub", "resub"):
        ...
        msg.streak_months = __get_single(line, "msg-param-streak-months") is not None and int(__get_single(line, "msg-param-streak-months"))
        ...
        msg.viewer_count = __get_single(line, "msg-param-viewerCount") is not None and int(__get_single(line, "msg-param-viewerCount"))
...
def __parse_roomstate(line: str) -> RoomState:
    ...
    msg.follower_only = __get_single(line, "followers-only") is not None and int(__get_single(line, "followers-only")) > -1
    msg.r9k = "1" == __get_single(line, "r9k")
    msg.slow = __get_single(line, "slow") is not None and int(__get_single(line, "slow"))
