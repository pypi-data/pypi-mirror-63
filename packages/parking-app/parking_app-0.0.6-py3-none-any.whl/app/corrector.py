...
from app.utils import get_job_step_configuration, local_job_dir, get_key_file
from app.parking_dataset import ParkingDatasetGcloud, ParkingDataset
...
class CorrectorJobWidget(QWidget):
    ...
    def reloadList(self):
        ...
        self.job_corrector.check_dataset_keyfile()
...
class CorrectorRegions(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.parking_dataset = ParkingDatasetGcloud(get_key_file())
        # self.parking_dataset = ParkingDataset('Z:\datasets\parking')



    def check_dataset_keyfile(self):
        self.parking_dataset.check_config(get_key_file())
