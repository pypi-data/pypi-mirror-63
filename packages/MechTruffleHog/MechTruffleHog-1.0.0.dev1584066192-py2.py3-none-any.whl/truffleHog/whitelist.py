...
class MetricCalculation:
    ...
    @staticmethod
    def diff_whitelists(whitelist, prev_whitelist):
        curr_whitelist = set()
        prev_whitelist = set()

        whitelist_object = json.loads(whitelist)
        for entry in whitelist_object:
            curr_whitelist.add(WhitelistEntry(**entry))
        
        prev_whitelist_object = json.loads(prev_whitelist)
        for entry in prev_whitelist_object:
            prev_whitelist.add(WhitelistEntry(**entry))
