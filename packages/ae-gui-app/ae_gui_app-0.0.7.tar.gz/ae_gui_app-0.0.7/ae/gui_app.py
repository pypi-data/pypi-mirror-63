...
least the two abstract methods :meth:`~MainAppBase.app_init`
...
:meth:`~MainAppBase.app_init` you could initialize
...
MIN_FONT_SIZE = 15                              #: minimum font size in pixels
MAX_FONT_SIZE = 99                              #: maximum font size in pixels

THEME_LIGHT_BACKGROUND_COLOR = (1, 1, 1, 1)     #: light theme background color in rgba(0.0 ... 1.0)
THEME_LIGHT_FONT_COLOR = (0, 0, 0, 1)           #: light theme font color in rgba(0.0 ... 1.0)
THEME_DARK_BACKGROUND_COLOR = (0, 0, 0, 1)      #: dark theme background color in rgba(0.0 ... 1.0)
THEME_DARK_FONT_COLOR = (1, 1, 1, 1)            #: dark theme font color in rgba(0.0 ... 1.0)
...
class MainAppBase(ConsoleApp, ABC):
    ...
    def __init__(self, debug_bubble: bool = False, **console_app_kwargs):
        ...
        :param debug_bubble:        pass True to activate debug bubble.
        :param console_app_kwargs:  kwargs to be passed to the __init__ method of the super-class / ConsoleApp instance.
        """
    ...
    def find_image_file(self, image_name: str, height: float = 32.0, light_theme: bool = True) -> str:
        ...
        :return:                image file path if found else empty string.
        """
    ...
    def find_sound(self, sound_name: str) -> Optional[CachedFile]:
        ...
        :return:                cached sound file if sound name was found else None.
        """
