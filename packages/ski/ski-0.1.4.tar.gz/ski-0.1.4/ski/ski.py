...
def assess(agents,save_figure=False):
    if save_figure:
    ...
    for agent in agents:
        plt.plot(agent.performance_memory.rmse_Q_dict.keys(),agent.performance_memory.rmse_Q_dict.values(),label=agent.name)
    plt.legend()
    plt.xlabel('Episode')
    plt.ylabel('Root Mean Squared Error of Q-value')
    plt.title('Root Mean Squared Error of Q-value over Episode')
    plt.show()
    ...
    plt.figure(figsize=[10,7])
    for agent in agents:
        plt.plot(agent.performance_memory.rmse_V_dict.keys(),agent.performance_memory.rmse_V_dict.values(),label=agent.name)
    plt.legend()
    plt.xlabel('Episode')
    plt.ylabel('Root Mean Squared Error of V-value')
    plt.title('Root Mean Squared Error of V-value over Episode')
    plt.show()
    ...
    plt.figure(figsize=[10,7])
    for agent in agents:
        plt.plot(agent.performance_memory.rmse_A_dict.keys(),agent.performance_memory.rmse_A_dict.values(),label=agent.name)
    plt.legend()
    plt.xlabel('Episode')
    plt.ylabel('Root Mean Squared Error of A-value')
    plt.title('Root Mean Squared Error of A-value over Episode')
    plt.show()
