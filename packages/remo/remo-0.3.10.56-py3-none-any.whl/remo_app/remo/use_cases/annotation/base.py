...
from remo_app.remo.api.constants import AnnotationSetType, TaskType, AnnotationSetStrictMode
...
class BaseAnnotationFormat(metaclass=ABCMeta):
    ...
    def decode_class(self, label_name: str) -> (str, str):
        """
        ...
        try:
            class_name = self.class_encoding.decode_class(label_name)
            return class_name, None
        except Exception as err:
            return label_name, str(err)
    ...
    def save_annotations(self, dataset_id, user_id, images_mapping, annotation_set_id=None) -> int:
        """
