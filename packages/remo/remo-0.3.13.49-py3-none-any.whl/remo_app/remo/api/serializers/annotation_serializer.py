...
class AnnotationCreateUpdateObjectSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        self._save_annotation_objects(annotation, annotation_info)
    ...
    def _save_annotation_objects(self, instance, annotation_info):
        classes = {}
        annotation_set_classes = {class_obj.name for class_obj in instance.annotation_set.classes.distinct()}
            ...
            for annotation_class in annotation.get('classes', []):
                ...
                try:
                    if class_name not in classes:
                        classes[class_name] = Class.objects.get(name=class_name)
...
class AnnotationCreateUpdateClassSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        self._save_annotation_classes(annotation, annotation_info)
    ...
    def _save_annotation_classes(self, instance, annotation_info):
        classes = {}
        annotation_set_classes = {class_obj.name for class_obj in instance.annotation_set.classes.distinct()}
