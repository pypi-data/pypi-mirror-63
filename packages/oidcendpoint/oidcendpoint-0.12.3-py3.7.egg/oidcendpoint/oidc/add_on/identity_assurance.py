...
OPTIONAL_EVIDENCE_LIST = ([Evidence], False, msg_list_ser, evidence_list_deser, False)
...
OPTIONAL_VERIFICATION_ELEMENT_REQUEST = (
    VerificationElementRequest, False, msg_ser, verification_element_request_deser, False)


class VerifiedClaimsRequest(Message):
    c_param = {
        "verification": OPTIONAL_VERIFICATION_ELEMENT_REQUEST,
        "claims": OPTIONAL_IDA_CLAIMS
    }
...
class ClaimsConstructor:
    ...
    def __setitem__(self, key, value):
        ...
        if _value_type:
            if not _correct_value_type(value, _value_type):
