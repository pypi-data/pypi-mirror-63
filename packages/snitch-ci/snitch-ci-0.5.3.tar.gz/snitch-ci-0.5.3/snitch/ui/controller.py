...
from PyQt5.QtCore import Qt, pyqtSlot, QModelIndex, QTimer
...
class Controller(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self._ui.actionCut.triggered.connect(self._cut)
        self._ui.actionCopy.triggered.connect(self._copy)
        self._ui.actionPaste.triggered.connect(self._paste)
        self._ui.actionDelete.triggered.connect(self._ui.eventMgmtButtons.ui.buttonDel.click)
...
########    ###    ######## ##    ##    ##     ######
    ...
    def add_event(self, event_type):
        ...
        """
        self._testcase.event_list.insert(self.get_selected_index()+1, event_type.text())
        self._ui.tableEvents.selectRow(self.get_selected_index()+1)
...
##       #### ######## ########    ##     ##  ######   ##     ##    ##    ###
    ...
    def new_testcase(self):
        ...
        self._ui.buttonClear.clicked.connect(self._clear)
    ...
    def save_result(self, filename):
        self._testcase.save(filename.replace('.json', '.result.json'))
...
##    ## ##     ## ##           ##     ##      ##        ##     ## ##    ##    ##    ##
 ######   #######  ##           ##    ##       ##        ##     ##  ######     ##    ########
    ...
    def _cut(self):
        self._copy()
        self._ui.eventMgmtButtons.ui.buttonDel.click()
