...
class Menu(GLXCurses.Window, GLXCurses.Movable):
    ...
    def _draw_action_area(self):
        ...
        if self._action_area:
            ...
            for button in self._action_area:
                ...
                button.widget.style.attribute_states['text']['STATE_NORMAL'] = 'BLACK'
                button.widget.style.attribute_states['bg']['STATE_NORMAL'] = 'WHITE'
                if button.widget.has_default is True:
